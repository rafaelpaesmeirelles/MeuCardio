...
function MiniTop({ contexto = "Clinical Command Center" }: { contexto?: string }) {
  return (
    <div className="cos-tour-mock__top">
      <span className="cos-tour-mock__brand"><img src="/atelier/corvia-mark-atelier.svg" alt="" /></span>
  ...
  return (
    <div className="cos-tour-mock cos-tour-mock--mobile">
      <div className="cos-tour-phone">
        <header><img src="/atelier/corvia-mark-atelier.svg" alt=""/><Icone nome="menu"/></header>
  ...
  return (
    <div className="cos-tour">
      <header className="cos-tour__top">
        <div className="cos-tour__brand"><img src="/atelier/corvia-logo-atelier.svg" alt="CorVIA Cardiology Spaces"/></div>
      ...
      <main className="cos-tour__stage">
        ...
        {final && <section className="cos-tour-final">
          <span className="cos-tour-final__mark"><img src="/atelier/corvia-mark-atelier.svg" alt="" /></span>
