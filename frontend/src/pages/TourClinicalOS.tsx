...
const SLIDES: Slide[] = [
  ...
  { id:"communication", eyebrow:"Comunicação", titulo:"Seu trabalho continua depois da consulta.", resumo:"CorVIA Mail permanece integrado ao Clinical OS e pode ser resumido pelo Assistente apenas quando autorizado.", promessa:"Comunicação profissional dentro do mesmo ambiente de trabalho.", icone:"mail", pontos:["Inbox premium", "HTML recebido isolado", "Assistente não lê caixa sem necessidade"], Mockup:MockCommunication },
