...
const SLIDES: Slide[] = [
  {
    ...
    uso: "Pesquise por doença (Guia de Doenças), diretriz, evidência, estudo, exame ou achado de imagem (Galeria) — tudo com uma busca só, em \"Busca\" ou dentro de cada seção. Marque o que usa com frequência como favorito para achar de novo em um clique.",
  ...
  },
  {
    ...
    resumo: "Escore, fluxograma, interação e contraindicação, prontos para usar.",
    uso: "Calculadoras validadas (CHA₂DS₂-VASc, HAS-BLED, GRACE e outras), fluxogramas em árvore de decisão, triagem por sintoma, checagem de interação entre medicamentos e checagem de contraindicação por condição especial (renal, gestação, hepatopatia, lactação).",
    beneficio: "Reduz o cálculo mental e a consulta cruzada de bula — o escore e a checagem já vêm com a interpretação e a conduta associada.",
    rotina: "Na beira do leito ou no ambulatório, decidir anticoagular, escalonar ou ajustar dose numa gestante vira uma consulta de 30 segundos, não uma pesquisa de 10 minutos.",
  },
  {
    icone: "emergencia",
    titulo: "Modo Emergência",
    resumo: "31 protocolos com fluxograma de conduta imediata — feito para funcionar sem rede.",
    uso: "Abra o Modo Emergência e o pacote inteiro (protocolos, documentos, fluxogramas) já fica salvo no aparelho — tocar num protocolo não depende de sinal de internet.",
    beneficio: "Numa parada ou numa emergência hipertensiva, o fluxograma de conduta aparece pronto, sem precisar lembrar a sequência de cor sob pressão.",
    rotina: "Corredor sem sinal, plantão de UPA, sala de emergência — é exatamente a situação para a qual esta tela foi desenhada.",
  },
  {
    icone: "prescricao",
