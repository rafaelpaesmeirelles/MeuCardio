...
- Cenas realistas próprias para Descobrir, Evidências, Aprender, Ensinar e Produzir: dez imagens, com versões diurnas e noturnas, otimizadas em WebP. Mantidos a disposição e o tamanho dos cartões existentes e os ícones semânticos pequenos. Prompts e arquivos em IMAGENS_CIENCIA_ENSINO_2026-09-09.md.
