...
## Dependências FA e CAD euglicêmica — 08/09/2026

FA: original inglês ESC2024 obtido no repositório institucional Erasmus, Table12, RecommendationTable14/19 e seção7.2.1 conferidas. Acrescentados gates para descompensação/contraindicações e FEVE desconhecida; taquicardiomiopatia não encerra controle só por FC<110. Pré-excitação e alternativas de ritmo qualificadas. AF-CARE: anticoagulação peri-cardioversão, exceção restrita e cronologia ADVENT corrigidas. Blanking: consenso integral PMC11000153, seções9.4–9.5; não aguardar semanas em piora, não confundir seguimento anual mínimo com primeira avaliação, antiarrítmico não obrigatório para todo redo tardio. CAD euglicêmica: consenso ADA/EASD2024, definição<200, DM1 não recomendado e retomada pós-CAD distinta de pausa perioperatória; cronologia e diversidade glicêmica FAERS corrigidas por comunicado primário FDA. Quatro YAML/status e alvos internos válidos; dois Mermaid válidos no parser real. Fonte_producao preservada.
