---
slug: vacinacao-cardiopata-no-consultorio-pos-sca-ic-checklist
title: 'Vacinação do cardiopata no consultório: checklist pós-SCA e IC'
kind: protocolo
theme: Geral
summary: 'Checklist ambulatorial para influenza, pneumococo e demais vacinas no cardiopata: prioridade pós-SCA/IC,
  contraindicações específicas e quando adiar por doença aguda clinicamente relevante.'
tags: []
source_refs:
...
- [ ] Reforçar alarmes: dor torácica nova/prolongada/crescente ou de alto risco, dispneia importante, síncope, hipotensão ou deterioração sistêmica → **via aguda**.
