...
source_refs:
- 'Garcia P, Ma SP, Shah S, Smith M, Jeong Y, Devon-Sand A, Tai-Seale M, Takazawa K, Clutter D, Vogt K, Lugtu C,
  Rojo M, Lin S, Shanafelt T, Pfeffer MA, Sharp C. Artificial Intelligence-Generated Draft Replies to Patient Inbox
  Messages. JAMA Netw Open. 2024;7(3):e243201. DOI: 10.1001/jamanetworkopen.2024.3201. PMID: 38506805'
- 'Crowley AP, Hanish A, Lubken J, Becker M, Rosen C, Moon J, Regli SH. Usage of and Satisfaction with Artificial
  Intelligence-Generated Draft Replies to Patient Portal Messages. Appl Clin Inform. 2026;17(3):510-517. DOI: 10.1055/a-2893-7363.
  PMID: 42361849'
- 'Owens K, Jayaram A, Chowdhury A, Pollak KI, Klotman S, Griffen Z, Danielski M, Goldstein B, Maddocks J, Roman
  M, Poon EG, Bedoya A, Cavalier J. Patient Perspectives on AI-Drafted Electronic Portal Messages. JAMA Netw Open.
  2026;9(7):e2622463. DOI: 10.1001/jamanetworkopen.2026.22463. PMID: 42412426'
legacy_source: Documento novo, escrito em 09/09/2026. Esta pasta já tem um documento sobre IA generativa aplicada
  a material educativo do paciente (legibilidade de texto gerado ou traduzido), mas nenhum cobria o uso de modelos
  de linguagem de grande porte (LLM) integrados ao prontuário eletrônico para RASCUNHAR a resposta do próprio médico/enfermagem
  às mensagens que o paciente envia pelo portal eletrônico — lacuna distinta (comunicação assíncrona bidirecional
  já em uso real em sistemas de saúde, não geração de material educativo unidirecional), coberta aqui com três estudos
  publicados entre 2024 e 2026, todos conferidos via PubMed nesta sessão.
summary: null
tags: []
evidence_level: null
source_tier: A
...
- **Redução estatisticamente significativa no escore de exaustão no trabalho** (média 1,95 pré-piloto vs. 1,62 pós-piloto; diferença pareada -0,33; IC95% -0,50 a -0,17; p < 0,001), em subamostra de 73 profissionais (45,1% dos 162 analisados) que completaram as duas pesquisas.
...
- **Taxa média de início de resposta a partir de rascunho de IA: 20,2%** — praticamente idêntica ao achado de Stanford, em sistema e ferramenta diferentes, o que reforça a semelhança descritiva entre esses dois pilotos, sem estimar adoção universal.
- Entre respostas comparadas aos rascunhos de IA, **40% tiveram pouca ou nenhuma edição**; esse indicador não equivale a 40% de todas as mensagens do portal.
- Em pesquisa com 52 respondentes: **33 concordaram que os rascunhos eram úteis**; **23 concordaram que a ferramenta melhorou a qualidade** das respostas.
...
- Conclusão dos autores: rascunhos de IA foram avaliados como geralmente aceitáveis e úteis, mas a expansão da ferramenta deve manter monitoramento contínuo de aceitabilidade, carga cognitiva **e segurança** — as menções a conteúdo inadequado exigem vigilância, mas não medem a proporção de rascunhos com erro.
...
1. **A taxa de adoção real gira em torno de 20%** das respostas em ambos os pilotos de implementação (Stanford e Penn Medicine, ferramentas diferentes) — não é adoção majoritária, ; as demais respostas não foram iniciadas com o rascunho da ferramenta, o que não demonstra que tenham sido escritas integralmente do zero.
...
3. **Foram relatados problemas no conteúdo dos rascunhos** — no estudo da Pensilvânia, 15 comentários foram classificados no tema conteúdo incorreto ou inadequado; a proporção refere-se a respostas qualitativas, não a todos os rascunhos ou pacientes, o que reforça que a revisão humana antes do envio não é uma formalidade opcional, e sim a etapa que evita que erro de IA chegue ao paciente.
...
## Armadilhas clínicas
- **Presumir que "rascunho revisado por humano" elimina o risco de erro clínico** — houve menções qualitativas a conteúdo incorreto ou inapropriado no rascunho; a revisão evita que esse erro chegue ao paciente apenas se for feita de fato, com atenção, e não como aprovação automática do texto pronto.
...
- [Inteligência artificial generativa na comunicação com o paciente cardiológico](/biblioteca/inteligencia-artificial-generativa-na-comunicacao-com-o-paciente-cardiologico)
- [Adesão ao tratamento cardiovascular com aplicativos e portal do paciente (mHealth)](/biblioteca/adesao-ao-tratamento-cardiovascular-com-aplicativos-e-portal-do-paciente-mhealth)
- [OpenNotes: acesso do paciente às notas médicas e comunicação em cardiologia](/biblioteca/opennotes-acesso-do-paciente-as-notas-medicas-e-comunicacao-em-cardiologia)
...
- [Documentação de decisão compartilhada e consentimento informado no prontuário e litígio em cardiologia](/biblioteca/documentacao-de-decisao-compartilhada-e-consentimento-informado-no-prontuario-e-litigio-em-cardiologia)
- [Teleconsulta em cardiologia: limites do exame físico a distância e evidência de não inferioridade](/biblioteca/teleconsulta-em-cardiologia-limites-do-exame-fisico-a-distancia-e-evidencia-de-nao-inferioridade)
