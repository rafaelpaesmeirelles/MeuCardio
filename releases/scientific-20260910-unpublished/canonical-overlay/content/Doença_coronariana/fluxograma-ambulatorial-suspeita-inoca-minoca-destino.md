...
summary: 'Árvore de consultório: SCA/MINOCA agudo → PS; sintoma estável após angiografia sem obstrução → RM ou teste
  funcional invasivo conforme a hipótese e o acesso ao exame escolhido.'
tags: []
source_refs:
