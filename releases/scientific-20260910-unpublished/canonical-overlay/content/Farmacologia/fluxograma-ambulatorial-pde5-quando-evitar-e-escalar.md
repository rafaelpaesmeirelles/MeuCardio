...
kind: fluxograma
theme: Farmacologia
summary: 'Árvore de consultório: paciente cardiológico pede ou usa PDE5 → filtro nitrato/riociguate/SCA → liberar
  vs contraindicar vs emergência por hipotensão — sem doses de DE.'
tags: []
source_refs:
...
flowchart TD
  ...
  D1 -->|"Sim"| D2{"Já há alarme ou suspeita de SCA/angina instável?<br/>Síncope / PA muito baixa /<br/>dor torácica pós-PDE5"}
