---
slug: sinalizadores-ambulatoriais-pos-tmcs-sitio-vascular-ic-avancada
title: 'Sinalizadores ambulatoriais pós-tMCS: sítio vascular e IC avançada'
kind: protocolo
theme: Terapia intensiva
summary: 'Dois eixos pós-tMCS: complicação vascular/acesso e trajetória de IC/choque; define PS, avaliação vascular
  precoce ou reavaliação com time implantador/IC avançada.'
tags: []
source_refs:
...
## Tudo com Tudo
O seguimento combina avaliação da recuperação cardíaca e das complicações do acesso, conforme os achados clínicos.
...
[Complicações do acesso large-bore](/biblioteca/acesso-vascular-large-bore-em-tmcs-prevencao-de-sangramento-isquemia-e-fechamento) · [Fluxograma pós-tMCS](/biblioteca/fluxograma-ambulatorial-pos-tmcs-destino) · [Seguimento após ponte](/biblioteca/seguimento-ambulatorial-pos-tmcs-ponte-temporaria-quando-escalar).

## Escopo da recomendação

Os consensos de choque e tMCS sustentam o reconhecimento de complicações e a coordenação especializada. Este roteiro pós-alta é uma aplicação operacional desses princípios; não representa escore validado de risco ambulatorial nem prescreve um prazo universal de retorno.
