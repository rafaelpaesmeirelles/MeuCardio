...
kind: protocolo
theme: Hipertensão
summary: 'Triagem ambulatorial de hipertensão: lesão aguda de órgão-alvo, exceção obstétrica PAS ≥160 OU PAD ≥110
  persistente, retinopatia hipertensiva grave, suspeita adrenérgica e PA muito elevada sem lesão aguda.'
tags: []
source_refs:
...
## Sinais/achados e prioridade de avaliação
...
4. Adulto não gestante com PAS ≥180 ou PAD ≥110mmHg e sem lesão aguda? → oral + retorno precoce.
