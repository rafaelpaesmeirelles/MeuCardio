...
kind: fluxograma
theme: Síncope
summary: 'Árvore ambulatorial pós-avaliação inicial: alto risco → via urgente; cicatriz/IAM ou outros substratos
  selecionados → EP/EPS; baixo risco sem substrato → monitorização/ILR; avaliação de CDI apenas conforme critérios
...
```mermaid
flowchart TD
  R0["Consulta ambulatorial<br/>síncope recorrente sem diagnóstico definido<br/>após avaliação inicial"] --> D1{"Há marcador de alto risco ou gravidade?<br/>Esforço/decúbito, cardiopatia estrutural/coronariana grave,<br/>ECG de alto risco, hipoperfusão ou trauma grave;<br/>sem pródromo/história familiar de MSC jovem<br/>associados a cardiopatia ou ECG anormal"}
  ...
  D4 -->|"Não ou incerto"| C5(["Unidade de síncope / retorno curto<br/>Reavaliar hipótese e risco<br/>Não forçar EPS nem CDI"])
...
- Na Tabela 6 da ESC2018, ausência de pródromo, história familiar de morte súbita jovem e síncope sentada são critérios menores, classificados como alto risco quando associados a cardiopatia estrutural ou ECG anormal. Ainda exigem investigação contextualizada; trauma grave altera disposição independentemente disso.
