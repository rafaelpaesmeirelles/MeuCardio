...
kind: fluxograma
theme: Síncope
summary: Após avaliação inicial de síncope, reabrir a estratificação diante de novos alarmes, investigar recorrências
  e definir observação ou seguimento conforme risco, ECG, contexto clínico e acesso seguro.
tags: []
source_refs:
...
Prosa: [sinalizadores-ambulatoriais-sincope-pos-alta-quando-retornar](/biblioteca/sinalizadores-ambulatoriais-sincope-pos-alta-quando-retornar). Gate atividades: [sincope-gate-ambulatorial-retorno-atividades-trabalho-direcao](/biblioteca/sincope-gate-ambulatorial-retorno-atividades-trabalho-direcao). Estratificação no DE: [fluxograma-sincope-criterios-de-alto-risco-emergencia-esc-2018-eusem-2024](/biblioteca/fluxograma-sincope-criterios-de-alto-risco-emergencia-esc-2018-eusem-2024).

## Árvore de decisão

```mermaid
flowchart TD
  R0["Consulta ambulatorial / pós-alta do DE<br/>síncope já estratificada como baixo risco<br/>ou seguimento após avaliação inicial"] --> D1{"Novo alarme de alto risco?<br/>síncope em esforço / decúbito<br/>novo evento preocupante em cardiopatia grave<br/>trauma relevante / dor torácica / dispneia aguda<br/>ECG alarmante / suspeita de falha de dispositivo<br/>hipoperfusão"}
...
- **D1** = gate de segurança. Ausência/pródromo muito curto, história familiar de morte súbita jovem e síncope sentada são critérios menores na tabela6 ESC2018: ganham classificação de alto risco em associação a cardiopatia estrutural ou ECG anormal. Exigem investigação contextual, sem equivaler isoladamente a emergência automática.
...
Baixo risco na alta descreve aquele momento. Novo fenótipo, trauma relevante, cardiopatia estrutural/coronariana grave, ECG alterado ou história familiar de morte súbita precoce reabrem estratificação. Ausência de pródromo isolada não determina alto risco; considerar os demais achados. Síncope durante esforço ou supina é marcador maior; síncope sentada deve ser interpretada junto ao substrato e ECG, como os demais marcadores menores. Se nem alto nem baixo risco após reavaliação, a recomendação ESC é observação no DE/unidade de síncope, não retorno curto rotulado Classe I.

Em portador de dispositivo estável, providenciar interrogação rápida com correlação clínica; instabilidade, choques recorrentes ou choque de CDI associado à síncope, trauma relevante, suspeita de BAV/pausas ou falta de acesso rápido exigem via urgente. Um choque isolado já avaliado em paciente estável segue plano específico do dispositivo. Convulsão prolongada, confusão persistente ou déficit focal seguem emergência neurológica apropriada. Recorrência inexplicada exige investigação com monitorização prolongada/ILR ou estudo eletrofisiológico conforme substrato, em vez de retornos curtos indefinidos.
