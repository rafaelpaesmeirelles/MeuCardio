...
class FullCorpusReleaseAuthorizationTests(unittest.TestCase):
    def test_manifesto_real_vincula_exatamente_o_corpus_revisado(self):
        ...
        self.assertEqual(sum(map(len, authorized.values())), 12554)
        self.assertEqual(metadata["authorized_total"], 12554)
