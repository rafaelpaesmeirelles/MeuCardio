...
EXPECTED_SUPPORT_FILES = {
    ...
    "frontend/src/pages/ScientificDocumentAI.tsx",
    ...
    "frontend/src/styles/cardiology-spaces-app-frame.css",
    ...
    "backend/app/models/scientific_user_document.py",
    "backend/app/models/patient_multimodal.py",
    ...
    "backend/app/services/scientific_document_ai.py",
