...
receita: **há alergia à penicilina** e **qual foi a gravidade do episódio**,
porque é a gravidade — não a idade isolada — que define até quando manter a
profilaxia.
...
flowchart TD
  ...
  D1 -->|"Não"| D2{"Qual foi a gravidade do episódio<br/>e há doença valvar residual?"}

  D2 -->|"Sem cardite, ou cardite leve,<br/>sem doença valvar residual"| C2(["Penicilina G benzatina intramuscular, dose por peso,<br/>por no mínimo 10 anos após o último episódio<br/>ou até os 21 anos de idade — o que ocorrer depois"])

  D2 -->|"Cardite moderada,<br/>sem doença valvar residual"| C3(["Penicilina G benzatina intramuscular, dose por peso,<br/>até os 35 anos de idade"])

  D2 -->|"Doença grave, com doença<br/>valvar residual persistente"| C4(["Penicilina G benzatina intramuscular, dose por peso,<br/>até os 40 anos de idade ou por período mais<br/>prolongado, a critério clínico individualizado"])
...
**"O que ocorrer depois" pode significar prazo indefinido.** Um paciente que
