...
- **A troca de classe de AINE na PSRA (naproxeno → celecoxibe) e o corticosteroide
  ...
  diretriz formal (ESC/AHA/SBC) não define esquema específico para PSRA, a
  evidência é insuficiente para transformar essa sequência em protocolo
  institucional; seu uso exige decisão individual e supervisão especializada.
