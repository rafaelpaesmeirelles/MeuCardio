...
flowchart TD
  ...
  D1 -->|"Não"| D2{"Sintoma persistente / QoL comprometida<br/>após angiografia sem obstrução?"}
  D2 -->|"Não"| C2(["Plano usual + alarmes escritos<br/>Retorno conforme rede"])

  D2 -->|"Sim"| D3{"História de troponina/MINOCA<br/>ou dúvida de miocardite/Takotsubo?"}

  D3 -->|"Sim"| C3(["Selecionar RM cardíaca<br/>+ retorno etiológico precoce"])
  ...
  D3 -->|"Não"| C4(["Selecionar CFT / centro ANOCA-INOCA<br/>se mecanismo incerto e sintomas persistentes"])
...
- Não cria links para conteúdos ainda ausentes da árvore.
