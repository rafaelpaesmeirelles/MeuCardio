...
review_note: "Produção científica assistida (Claude, 26/08/2026); pendente de revisão independente e validação médica final. Conferido nesta sessão: texto integral da seção 3.3 (biomarcadores, algoritmos rápidos, Figura 6 e tabela de recomendações de diagnóstico), da tabela 2 de recomendações de imagem não invasiva e da tabela de timing da estratégia invasiva, na tradução oficial da SEC da diretriz ESC 2023 de SCA (PDF); Tabela S4 (cortes por ensaio, 0 h/1 h e 0 h/2 h) e seções 3.3.2.1 a 3.3.2.3 do material suplementar da mesma diretriz (PDF ehad191 supplementary data); artigo dos 10 mandamentos da diretriz (OUP). Derivado de fluxograma-sindrome-coronariana-aguda-esc-2023 e sindrome-coronariana-aguda-timing-invasivo-e-dapt-esc-2023, já publicados no acervo. O texto integral em inglês em academic.oup.com não abriu além do sumário nesta sessão."
source_refs:
