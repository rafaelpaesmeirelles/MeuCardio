...
review_note: "Produção científica assistida (Claude, 26/08/2026); pendente de revisão independente e validação médica final. Lidos nesta sessão: o texto integral da Fourth Universal Definition of Myocardial Infarction (Thygesen 2018, Eur Heart J 2019, via academic.oup.com — critérios de lesão aguda e crônica, critérios de IAM tipo 1 e tipo 2, mecanismos de oferta-demanda, manejo do tipo 2, seções sobre doença renal crônica, insuficiência cardíaca, takotsubo e paciente crítico) e o texto integral das 2023 ESC ACS Guidelines em PDF (seções 3.3.1, 3.3.3, 3.3.4 e 12.1, incluindo a ausência de tabela de recomendação específica para IAM tipo 2, e a Recommendation Table 13 do MINOCA); o estudo Delphi de Taggart 2025 foi lido no PMC apenas para os dados de prognóstico e consenso citados na prosa. Derivado dos documentos já publicados no acervo sindrome-coronariana-aguda-diagnostico-e-manejo-esc-2023 e fluxograma-sindrome-coronariana-aguda-esc-2023. Não duplica fluxograma-mins-lesao-miocardica-pos-operatoria (perioperatório) nem fluxograma-troponina-pos-exercicio-intenso-atleta (atleta), ambos lidos. Os cortes por ensaio do algoritmo 0 h/1 h ficam na Tabela S4 do suplemento da ESC 2023, que não foi aberta, e por isso não são listados. Verificação adversarial (Claude, 26/08/2026): DOIs e PMIDs conferidos no Crossref e no PubMed; percentuais da ESC 2023 (300%/40%, 87%, classes I B/I B/I C do MINOCA, seção 12.1) reconferidos no PDF extraído localmente; Quarta Definição (20%, critérios do tipo 2, manejo, mortalidade, takotsubo, DRC, IC, paciente crítico) reconferida no texto da OUP; Delphi de Taggart 2025 reconferido no PMC (97%, 89%, 95%, 70%, dois terços em cinco anos) com a frase do 89% ajustada para o enunciado exato (angiografia invasiva na internação em alta probabilidade de DAC ou isquemia em curso) e DOI/volume acrescentados à referência; os sete links do Tudo com Tudo apontam para slugs existentes no acervo."
source_refs:
...
flowchart TD
  ...
  D4 -->|"Sim"| D6{"Apresentação compatível com<br/>aterotrombose aguda: SCA típica sem<br/>precipitante ou placa rota com trombo<br/>na angiografia?"}
...
- A ordem entre o nó de aterotrombose (D6) e o de precipitante (D7) é uma escolha editorial coerente com a Quarta Definição; em paciente com precipitante e quadro típico simultâneos, a diretriz não define prioridade e o julgamento clínico prevalece.
