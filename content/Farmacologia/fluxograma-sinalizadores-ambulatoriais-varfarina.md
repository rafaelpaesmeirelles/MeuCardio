...
review_note: "Revisão clínica/editorial Codex em 08/09/2026: fontes primárias e identificadores conferidos; corrigidos limites da recomendação ASH, INR extremo, trauma craniano, sangramento não maior relevante e acesso ao seguimento. Aprovação restrita a este conteúdo; não representa revisão humana independente."
source_refs:
...
flowchart TD
  ...
  D4 -->|"Não / alto risco residual"| C5(["Garantir avaliação no mesmo dia<br/>ou PS se novos alarmes"])
