...
review_note: "Produção científica assistida (Claude, 26/08/2026); pendente de revisão independente e validação médica final. Conferido nesta sessão: texto integral da revisão do SELECT em PMC11439431 (critérios de inclusão, dose, MACE 6,5% vs 8,0%, HR 0,80, peso, descontinuação); resumo indexado do SUMMIT via Europe PMC (n, FEVE, IMC, dose, desfechos, HR); resumo indexado e pontos-chave do consenso ESC 2024 sobre obesidade (ACC ten points e página de destaques da ESC: limiar de fármaco IMC 30 ou 27 com comorbidade, limiar cirúrgico IMC 40 ou 35 com doença relacionada, déficit calórico, meta de 5 a 10%); recomendações de peso e cirurgia bariátrica da diretriz ESC 2021 de prevenção (classe I A e IIa B) no texto da OUP; bulas de Wegovy e Zepbound no DailyMed (indicação, contraindicações CMT/NEM2, alerta de pancreatite, escalonamento de dose). Os números do STEP-HFpEF e do STEP-HFpEF DM vêm dos documentos já verificados no acervo (o resumo do PubMed não abriu nesta sessão); os números do SOS, da coorte de Aminian, da recomendação cirúrgica da ESC 2023 e do capítulo 10 da ADA 2026 também vêm dos documentos do acervo listados em source_refs. Verificação adversarial (26/08/2026): DOIs e PMIDs conferidos no Crossref e no PubMed; resumos do STEP-HFpEF (PMID 37622681), STEP-HFpEF DM (PMID 38587233) e Look AHEAD (PMID 23796131) lidos via E-utilities; classes I A e IIa B da ESC 2021 conferidas na tabela de recomendações do PDF integral; limiares de fármaco e cirurgia e frase sobre a semaglutida 2,4 mg conferidos na página de destaques Part II da ESC; nenhum número corrigido. Ajustes de forma: rótulo de D3 simplificado para IMC de 35 ou mais e acrescentada limitação sobre ICFEp com IMC entre 27 e 30."
source_refs:
...
- O SUMMIT incluiu pacientes com e sem diabetes; a proporção de diabéticos não foi conferida nesta sessão — VERIFICAÇÃO HUMANA NECESSÁRIA antes de citar o SUMMIT como evidência específica do subgrupo diabético.
