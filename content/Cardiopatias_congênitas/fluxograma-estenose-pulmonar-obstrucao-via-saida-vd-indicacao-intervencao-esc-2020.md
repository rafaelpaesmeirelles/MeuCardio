...
flowchart TD
  ...
  D3 -->|"Sim"| D4{"A troca valvar cirúrgica é a<br/>única opção — anatomia inadequada<br/>à valvuloplastia por balão?"}

  D4 -->|"Não — valvuloplastia por balão<br/>é anatomicamente adequada"| C3(["Intervenção recomendada independente<br/>de sintomas — Classe I, nível C.<br/>Valvuloplastia por balão é a intervenção<br/>de escolha na estenose valvar<br/>anatomicamente adequada — Classe I,<br/>nível C"])

  D4 -->|"Sim — só a troca valvar<br/>cirúrgica é tecnicamente viável"| D5{"O paciente é sintomático, ou<br/>assintomático com pelo menos um<br/>destes: queda objetiva da capacidade<br/>de exercício; queda de função de VD<br/>e/ou progressão de regurgitação<br/>tricúspide para pelo menos moderada;<br/>pressão sistólica de VD acima de<br/>80 mmHg; shunt direita-esquerda<br/>via CIA/CIV?"}
