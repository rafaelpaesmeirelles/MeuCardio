...
summary: 'Árvore de consultório: adulto com Eisenmenger/cianose crônica + sintoma ou mudança de status → PS+ACHD
  agora vs. escalação urgente ao centro vs. retorno de rotina com reforço do que não fazer.'
tags: []
source_refs:
...
Prosa: [`sinalizadores-ambulatoriais-eisenmenger-cianose-quando-escalar`](/biblioteca/sinalizadores-ambulatoriais-eisenmenger-cianose-quando-escalar). Braço o-que-não-fazer: [`eisenmenger-cianose-ambulatorial-o-que-nao-fazer-sem-doses`](/biblioteca/eisenmenger-cianose-ambulatorial-o-que-nao-fazer-sem-doses). ACHD geral: [`sinalizadores-ambulatoriais-em-cardiopatia-congenita-do-adulto-quando-encaminhar`](/biblioteca/sinalizadores-ambulatoriais-em-cardiopatia-congenita-do-adulto-quando-encaminhar). Hospitalar: [`descompensacao-aguda-da-sindrome-de-eisenmenger-e-cardiopatia-cianotica`](/biblioteca/descompensacao-aguda-da-sindrome-de-eisenmenger-e-cardiopatia-cianotica).
...
flowchart TD
  ...
  D1 -->|"Não"| D2{"Piora progressiva estável?<br/>esforço ↓ · edema insidioso<br/>arritmia não sustentada sem repercussão<br/>hemoptise nova pequena / nunca visto em ACHD"}

  D2 -->|"Sim"| C2(["Escalar URGENTE ao centro ACHD<br/>Hemoptise nova: avaliar no mesmo dia<br/>Não esperar retorno anual<br/>Reavaliar HAP / arritmia / ferro"])
