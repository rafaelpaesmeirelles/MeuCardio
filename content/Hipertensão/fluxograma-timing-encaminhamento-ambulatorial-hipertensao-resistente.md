...
kind: fluxograma
fonte_producao: grok
summary: "Árvore de consultório: emergência/obstetrícia primeiro; depois excluir pseudorresistência e inércia terapêutica antes de confirmar resistência verdadeira; por fim decidir seguimento local versus centro especializado."
review_status: revisado
review_note: "Revisão clínica final 08/09/2026. Adicionados gate obstétrico PAS >=160/PAD >=110, composição/dose/duração do esquema antes de rotular resistência verdadeira e condicionamento de denervação à confirmação de resistência e causas secundárias. Removidos handoffs para PRs ainda não publicados."
source_refs:
  ...
  - "Lewis P, George J, Kapil V, et al. Adult hypertension referral pathway and therapeutic management. J Hum Hypertens. 2024;38(1):3-7. PMID: 38196000"
  - "Faconti L, et al. Investigation and management of resistant hypertension: BIHS position statement. J Hum Hypertens. 2024. PMID: 39653728"
---
...
flowchart TD
  ...
  D0 -->|"Não"| OB{"Gestação/puerpério<br/>PAS >=160 OU PAD >=110 persistente?"}
  OB -->|"Sim"| COB(["Via obstétrica/hospitalar urgente<br/>Ver fluxo de eclâmpsia/HTA grave"])
  OB -->|"Não"| D1{"Pseudorresistência e inércia excluídas?<br/>técnica + adesão + MAPA/MRPA<br/>+ esquema adequado + doses otimizadas<br/>+ tempo suficiente"}

  D1 -->|"Não"| C1(["Não rotular como resistente verdadeira<br/>Corrigir técnica/adesão/composição/titulação<br/>Referir só se houver outro motivo"])

  D1 -->|"Sim"| D2{"Serviço local consegue otimizar<br/>e monitorar com segurança?"}
  D2 -->|"Sim"| C2(["Seguimento local próximo<br/>Aplicar algoritmo canônico de tratamento"])
