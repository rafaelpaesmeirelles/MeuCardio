...
review_note: "Produção científica assistida (Claude, 26/08/2026); pendente de revisão independente e validação médica final. Lidos na íntegra nesta sessão, em PDF baixado de kdigo.org: KDIGO 2024 CKD (capítulo 3 — recomendações 3.4.1, 3.6.1 a 3.6.4, 3.7.1 a 3.7.3, 3.8.1 e pontos de prática 3.6.1 a 3.6.7, 3.7.1 a 3.7.3, 3.8.1 a 3.8.5, Figura 26) e KDIGO 2021 BP in CKD (recomendações 3.1.1, 3.2.1 a 3.2.3, 3.3.1, 4.1 e pontos de prática 3.1.1 a 3.2.7, texto sobre diuréticos de alça em TFGe abaixo de 30). A Tabela de Recomendações 26 da ESC 2024 (seção 9.7, DRC) foi lida no texto integral em academic.oup.com; a prosa da seção 9.7 não foi recuperada. Derivado dos documentos já publicados do acervo: elevacao-de-creatinina-ao-iniciar-ieca-ou-bra-quando-manter-e-quando-suspender, controle-pressorico-na-doenca-renal-cronica-estagios-3-a-5, finerenona (Farmacologia), finerenona-fidelio-dkd-figaro-dkd-e-a-fidelity, confidence-combinacao-de-finerenona-e-empagliflozina-na-doenca-renal-cronica-diabetica, fluxograma-hipercalemia-em-uso-de-ieca-bra-ou-espironolactona e fluxograma-escolha-isglt2-glp1-diabetico-doenca-cardiovascular. Revisão adversarial (26/08/2026): KDIGO 2024 e 2021 reconferidos no PDF (recomendações, pontos de prática e Figura 26 batem); DOIs e PMIDs conferidos no Crossref e PubMed. Correções: o ramo de hipotensão sintomática desembocava na folha de hipercalemia — folha ajustada para reduzir ou suspender (ponto de prática 3.6.5); o ramo sem albuminúria omitia o diabetes tipo 2 com TFGe de 20 ou mais, que tem iSGLT2 recomendado 1A (recomendação 3.7.1) — decisão e folha ajustadas; folha de finerenona ganhou a conduta para PA acima do alvo. A Tabela 26 da ESC 2024 não pôde ser reaberta na revisão (academic.oup.com truncou antes da seção 9.7 em todas as tentativas); as classes e níveis atribuídos à ESC 2024 para IECA/BRA, finerenona, diurético de alça e alvo abaixo de 140 em TFGe abaixo de 30 ficaram marcados VERIFICAÇÃO HUMANA NECESSÁRIA — o alvo 120 a 129 se tolerado e o iSGLT2 classe I, nível A em TFGe de 20 ou mais foram confirmados em síntese secundária (Medicina 2025, PMC11857694; Ten Hot Topics, PMC13046305)."
source_refs:
...
|---|---|---|---|
| ESC 2024, Tabela 26 | 120–129 mmHg | DRC, se tolerado — classe I | TFGe abaixo de 30: alvo menos intensivo, abaixo de 140 mmHg, pode ser considerado — classe IIb, nível C (VERIFICAÇÃO HUMANA NECESSÁRIA: linha da Tabela 26 não reproduzida na revisão) |
...
A ESC 2024 coincide: IECA ou BRA recomendados na DRC com albuminúria moderada a grave, classe I, nível A (VERIFICAÇÃO HUMANA NECESSÁRIA: classe e nível da Tabela 26 não reproduzidos na revisão; a ESH 2023 traz a mesma classificação). Três regras acompanham a prescrição, todas do KDIGO 2024 (pontos de prática 3.6.1 a 3.6.5) e repetidas do KDIGO 2021:
...
O KDIGO 2024 (recomendação 3.8.1, 2A) sugere antagonista mineralocorticoide não esteroidal com benefício renal ou cardiovascular comprovado para adultos com diabetes tipo 2, TFGe acima de 25, potássio normal e albuminúria acima de 30 mg/g apesar da dose máxima tolerada de IECA ou BRA; pode ser adicionada a IECA ou BRA e iSGLT2 (ponto de prática 3.8.2). A ESC 2024 recomenda finerenona no diabetes tipo 2 com DRC e albuminúria, classe I, nível A (VERIFICAÇÃO HUMANA NECESSÁRIA: classe e nível da Tabela 26 não reproduzidos na revisão; a ESC 2023 de diabetes dá classe I, nível A). As doses e os cortes de potássio abaixo são os da Figura 26 do KDIGO 2024, adaptada dos protocolos de FIDELIO-DKD e FIGARO-DKD, e conferem com o RCM europeu registrado em finerenona (Farmacologia):
...
Abaixo de 30, o IECA ou BRA continua (KDIGO 2024, ponto de prática 3.6.7), o diurético muda: a ESC 2024 recomenda diurético de alça quando a TFGe está abaixo de 30, classe I, nível C (VERIFICAÇÃO HUMANA NECESSÁRIA: classe e nível da Tabela 26 não reproduzidos na revisão), e o KDIGO 2021 registra que os tiazídicos perdem eficácia natriurética e pressórica com a queda da filtração, embora clortalidona, metolazona e indapamida pareçam manter efeito abaixo de 30, e que os diuréticos de alça são frequentemente eficazes nessa faixa — sem dado de desfecho clínico para nenhum deles na hipertensão. Abaixo de 20, não se inicia iSGLT2, mas não se retira o que já estava em uso. Abaixo de 15 com sintomas urêmicos, reduzir ou suspender o bloqueio do SRAA passa a ser opção legítima de conforto, e o preparo da terapia renal substitutiva é a decisão principal. Transplantado renal e paciente em diálise ficam fora desta árvore: no transplantado, o KDIGO 2021 fixa alvo abaixo de 130/80 mmHg e BCC di-hidropiridínico ou BRA como primeira linha (recomendação 4.1, 1C).
