...
> atualizada em setembro de 2025, com mudanças relevantes o suficiente para tornar o conteúdo antigo
> obsoleto em pontos centrais — a meta pressórica, o escore de risco e a própria classificação da PA.
...
A classificação usa o maior valor entre PAS e PAD.

## Conduta de seguimento por classificação

- **PA normal**: reavaliação anual.
- **Pré-hipertensão**: solicitar MAPA ou MRPA — risco de hipertensão mascarada (PA normal no consultório, elevada fora dele).
- **HAS estágio 1 ou 2**: solicitar MAPA ou MRPA — risco de hipertensão do avental branco. No estágio 2, apesar da indicação de MAPA/MRPA, a probabilidade de hipertensão sustentada já é alta.
- **HAS estágio 3 ou crise hipertensiva**: iniciar tratamento diretamente, sem esperar confirmação por MAPA/MRPA.
...
- **PA ≥ 140/90 mmHg**: tratamento medicamentoso desde o diagnóstico.
- **PA 130–139/80–89 mmHg com alto risco cardiovascular**: tratamento medicamentoso se não houver controle após 3 meses de medidas não medicamentosas.
- **Idosos ≥ 60 anos, incluindo ≥ 80 anos**: tratamento medicamentoso a partir de PAS ≥ 140 mmHg, com individualização em caso de hipotensão ortostática, fragilidade moderada/grave ou expectativa de vida < 3 anos.
...
Podem iniciar com **monoterapia**:
- PA 130–139/80–89 mmHg com alto risco cardiovascular;
- HAS estágio 1 com risco cardiovascular baixo;
- idosos ≥ 80 anos;
- pacientes frágeis;
...
- Hipertensão secundária (investigação e causas).
- Hipertensão em populações específicas (crianças, gravidez — ver tema Gravidez).
- Detalhe farmacológico de cada classe/fármaco — ver Farmacologia.
