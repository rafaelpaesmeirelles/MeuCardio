---
title: "Hipertensão Arterial e Pressão Arterial Elevada (ESC 2024)"
...
# Hipertensão Arterial e Pressão Arterial Elevada (ESC 2024)

## Definicao nova classificacao
Substitui a classificação anterior por três categorias simplificadas: PA não elevada (<120/70 mmHg), PA elevada (120-139/70-89 mmHg) e hipertensão (≥140/90 mmHg confirmada)

## Diagnostico
Hipertensão requer confirmação de PA sistólica ≥140 mmHg ou diastólica ≥90 mmHg, idealmente com medidas fora do consultório (MAPA/MRPA)

## Metas terapeuticas
- **meta principal**: Nova meta padrão de PA sistólica de 120-129 mmHg para a maioria dos adultos em tratamento farmacológico (Classe I), representando intensificação relevante em relação à diretriz anterior
- **meta diastolica**: 70-79 mmHg (Classe IIb)
- **excecoes meta relaxada**: PA 'tão baixa quanto razoavelmente alcançável' recomendada em caso de intolerância ao tratamento, adultos ≥85 anos, hipotensão ortostática sintomática, fragilidade moderada-grave ou expectativa de vida limitada
- **fonte**: AHA Hypertension Journal ; ACC Ten Points
...
- **primeira escolha**: Espironolactona (ou eplerenona se não tolerada) como fármaco preferencial adicional
- **segunda escolha**: Betabloqueadores
- **opcoes adicionais**: Alfabloqueadores, hidralazina e outros diuréticos poupadores de potássio (Classe IIa); denervação renal pode ser considerada (Classe IIb)
- **fonte**: European Heart Journal Cardiovascular Pharmacotherapy

## Criterios internacao
 (aplicável a crise hipertensiva/emergência hipertensiva, não abordada em detalhe nesta atualização)
