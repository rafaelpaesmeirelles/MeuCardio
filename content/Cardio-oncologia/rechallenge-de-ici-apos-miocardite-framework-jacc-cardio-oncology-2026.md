...
Considerar resposta prévia ao ICI, agressividade e estágio tumoral, alternativas terapêuticas, benefício esperado, prognóstico oncológico e preferências do paciente.

### 2. Certeza do diagnóstico original

Revisar se o evento realmente foi miocardite por ICI. Diagnósticos alternativos como síndrome coronariana aguda, Takotsubo, miocardite infecciosa, arritmia/IC por outra causa ou miosite com troponina T elevada podem alterar radicalmente a estimativa de recorrência.

### 3. Gravidade do episódio índice

Choque, arritmia ventricular, BAV avançado, disfunção ventricular importante ou overlap com miosite/miastenia representam fenótipo de maior preocupação. Não existe uma pontuação validada que converta esses achados em probabilidade individual de recorrência.

**Probabilidade numérica de recorrência por subtipo clínico: VERIFICAÇÃO HUMANA NECESSÁRIA.**

### 4. Recuperação cardiovascular

Antes de considerar reinício, documentar recuperação clínica e objetiva com sintomas, ECG/condução, troponina, função ventricular por eco e CMR quando necessária. O primer não estabelece um único valor universal de troponina, strain, FEVE ou realce tardio que autorize rechallenge isoladamente.

### 5. Capacidade de vigilância e resgate

A decisão só é defensável quando existe estrutura para detectar recorrência cedo e agir rapidamente. **Frequência universal de troponina/ECG após cada ciclo no rechallenge: VERIFICAÇÃO HUMANA NECESSÁRIA.**
