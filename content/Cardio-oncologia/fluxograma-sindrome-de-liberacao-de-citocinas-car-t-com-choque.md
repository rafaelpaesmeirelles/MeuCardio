...
flowchart TD
  ...
  P1["Monitorização contínua, acesso venoso,<br/>avaliar perfusão, lactato, ECG e troponina;<br/>considerar ecocardiograma se repercussão cardiovascular"]
  D2{"Gravidade pelo pior componente ASTCT"}
  C2(["Grau 2: hipotensão sem vasopressor<br/>ou O2 por baixo fluxo ≤6 L/min;<br/>suporte + considerar tocilizumabe conforme protocolo CAR-T"])
  C3(["Grau 3: 1 vasopressor ± vasopressina<br/>ou O2 por alto fluxo >6 L/min/máscara;<br/>UTI, tocilizumabe e suporte de órgão"])
  ...
  P2["Tocilizumabe IV para CRS grave/ameaçador à vida:<br/>≥30 kg: 8 mg/kg; <30 kg: 12 mg/kg;<br/>infusão em 60 min; máximo 800 mg por infusão"]
