---
title: "IC-OS/MASCC 2026 — padrão mínimo de cuidado cardiovascular no adulto com câncer"
slug: ic-os-mascc-2026-padrao-minimo-de-cuidado-cardiovascular-no-adulto-com-cancer
...
```mermaid
flowchart TD
    A[Adulto com câncer iniciando ou recebendo terapia sistêmica] --> B[Avaliação cardiovascular basal proporcional ao tratamento]
    B --> C{Doença CV conhecida, sintomas, fatores de risco descontrolados ou terapia de maior toxicidade?}
    C -- Não --> D[Otimizar prevenção primária e seguir vigilância específica da terapia]
    C -- Sim --> E[Definir avaliação adicional e necessidade de cardio-oncologia/cardiologia]
    E --> F[Otimizar fatores de risco e doença CV sem atrasar tratamento oncológico desnecessariamente]
    D --> G[Iniciar/continuar terapia oncológica]
    F --> G
    G --> H[Monitorar sintomas, PA, fatores de risco e testes específicos conforme a terapia]
    H --> I{Novo sintoma, biomarcador/imagem alterado ou fator de risco descontrolado?}
    I -- Não --> J[Continuar tratamento e vigilância proporcional]
    I -- Sim --> K[Reavaliar toxicidade, doença CV e necessidade de modificação do tratamento]
    K --> L{Emergência ou toxicidade cardiovascular clinicamente relevante?}
    L -- Sim --> M[Tratar evento e coordenar decisão oncológica em equipe multidisciplinar]
    L -- Não --> N[Otimizar tratamento CV e ajustar vigilância]
    J --> O[Término da terapia ou seguimento em terapia prolongada]
    M --> O
    N --> O
    O --> P[Reavaliar risco cardiovascular e construir plano de vigilância de longo prazo]
```
