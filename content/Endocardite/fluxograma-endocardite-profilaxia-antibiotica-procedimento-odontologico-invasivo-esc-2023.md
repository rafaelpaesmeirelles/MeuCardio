...
review_note: "Auditoria científica em 26/08/2026 contra as Seções 3.2–3.3 e Tabela 6 da ESC 2023 (PMID 37622656). Corrigida a definição de cardiopatia congênita de alto risco, inclusive limite de 6 meses e indicação vitalícia quando persiste shunt ou regurgitação valvar; confirmada a ausência de esquema padronizado para procedimentos não odontológicos. Mantida pendência de revisão médica antes da publicação clínica."
...
```mermaid
flowchart TD
  R0["Paciente vai ser submetido a procedimento<br/>odontológico ou não odontológico invasivo —<br/>avaliar necessidade de profilaxia antibiótica<br/>para endocardite infecciosa"] --> D1{"Paciente pertence à população de alto risco?<br/>prótese valvar/material de reparo valvar; EI prévia;<br/>cardiopatia congênita cianótica não reparada;<br/>reparo congênito com prótese há menos de 6 meses,<br/>ou vitalício se persistir shunt/regurgitação;<br/>dispositivo de assistência ventricular definitivo"}
  ...
  D3 -->|"Sim, COM história de<br/>anafilaxia, angioedema ou<br/>urticária a penicilina —<br/>não usar cefalosporina"| C4(["Azitromicina ou claritromicina 500mg,<br/>ou doxiciclina 100mg, via oral em dose única;<br/>se via oral for impossível, discutir alternativa<br/>com infectologia — a ESC não padroniza uma"])
...
- **Não existe esquema de fármaco/dose padronizado para o ramo Classe IIb** (procedimento
  ...
  escolha deve ser discutida caso a caso, idealmente com infectologia; não se deve
  transportar automaticamente o esquema odontológico para esse contexto.
...
- **Cardiopatia congênita reparada com material protético** mantém indicação por 6 meses
  após o procedimento; a indicação é vitalícia se permanecer shunt residual ou
  regurgitação valvar. Prótese valvar segue, por si só, como condição de alto risco.
