...
review_note: "Árvore construída integralmente a partir do documento já publicado e revisado 'timing-cirurgico-apos-avc-na-endocardite-infecciosa-esc-2023.md' desta pasta, que transcreve o texto integral da Seção 10.4 e da Recommendation Table 17 da diretriz ESC 2023 (lida linha a linha em sessão anterior, a partir de PDF de acesso aberto). Nenhuma fonte nova foi consultada; as três recomendações (AIT, AVC com coma ausente/hemorragia excluída, hemorragia intracraniana) e suas classes/níveis foram conferidas contra o corpo desse documento antes de montar a árvore, preservando a ressalva já registrada de que a condição-chave não é o tipo de evento, e sim ausência de coma e exclusão de hemorragia por imagem."
