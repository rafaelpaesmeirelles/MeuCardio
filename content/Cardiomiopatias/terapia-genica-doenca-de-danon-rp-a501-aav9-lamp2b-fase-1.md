...
source_refs:
- 'Greenberg B, Taylor M, Rossano JW, et al. Phase 1 Study of AAV9.LAMP2B Gene Therapy in Danon Disease. N Engl J Med. 2025;392(10):972-983.
  DOI: 10.1056/NEJMoa2412392. PMID: 39556016.'
...
legacy_source: Documento novo, escrito em 01/09/2026. Não havia nenhum documento dedicado à doença de Danon nem à sua terapia gênica
  em content/Cardiomiopatias/ — a doença aparece apenas citada como fenocópia glicogênica de CMH dentro de outros documentos (CMH ESC
  2023 versão completa; doença de Pompe; cardiomiopatia pediátrica dilatada e hipertrófica) e como entrada de metadados de doença (doencas/fragmentos/fenocopias-glicogenicas-da-cardiomiopatia-hipertrofica-danon-e-prkag2.json),
  sem cobertura do primeiro ensaio clínico publicado de terapia gênica para essa condição (NEJM, março de 2025). Gap real de 0 hits
  para este ensaio específico, confirmado por grep amplo em content/**/*.md, doencas/metadados.json, doencas/fragmentos/*.json e doencas/correcoes/*.json.
review_note: 'Revisão08/09/2026: tríade corrigida; CDI individualizado não extrapolado LMNA; segurança fase2 óbito/hold/retomada separados
  da fase1; comunicados não promovidos a eficácia.'
