---
title: 'Fibrilação Atrial na Cardiomiopatia Hipertrófica: Anticoagulação Independente
  do CHA₂DS₂-VASc'
...
source_refs:
- 'Alasmar R, Ibrahim R, AlHammouri H, et al. Direct Oral Anticoagulants Versus Warfarin
  in Patients with Atrial Fibrillation and Hypertrophic Cardiomyopathy: A Retrospective
  Cohort Study. Am J Cardiovasc Drugs. 2026;26(3):375-381. DOI: 10.1007/s40256-026-00791-y.
  PMID: 41838376'
- 'Julakanti RR, Gilreath KM, Debertin J, et al. Risk Factors for Left Atrial Thrombus
  in Patients with Hypertrophic Cardiomyopathy and Atrial Fibrillation. J Am Soc Echocardiogr.
  2026 Jun 10. DOI: 10.1016/j.echo.2026.06.001. PMID: 42269731'
- 'Liu M, Huang S, Kawana M, Wheeler MT, Parikh V, Perez MV. Distinct mechanistic
  features of atrial fibrillation in hypertrophic cardiomyopathy. Heart Rhythm. 2026
  May 7. DOI: 10.1016/j.hrthm.2026.03.1958. PMID: 41956264'
- 'Rowin EJ, Siontis KC, Owens A, et al. Atrial fibrillation in hypertrophic cardiomyopathy:
  a unique clinical entity requiring dedicated study. Heart Rhythm. 2026;23(8):e1672-e1682.
  DOI: 10.1016/j.hrthm.2026.03.1961. PMID: 41956263'
- 'Aglan A, Fath AR, Silver JS, Harnish P, Hook B, Maron MS, Rowin EJ. Atrial fibrillation
  recurrence and outcomes in patients with hypertrophic cardiomyopathy: insights from
  a nationwide real-world cohort. Heart Rhythm. 2026;23(9):e1823-e1833. DOI: 10.1016/j.hrthm.2026.03.1906.
  PMID: 42029363'
- 'Angelescu CM, Iosifescu TA, Căldăraru CI, et al. New Insights in the Diagnosis
  and Treatment of Atrial Fibrillation in Patients with Hypertrophic Obstructive Cardiomyopathy.
  J Clin Med. 2026;15(8):3014. DOI: 10.3390/jcm15083014. PMID: 42074815'
- 'Arbelo E, Protonotarios A, Gimeno JR, et al. 2023 ESC Guidelines for the management
  of cardiomyopathies. Eur Heart J. 2023;44(37):3503-3626. DOI: 10.1093/eurheartj/ehad194.
  PMID: 37622657'
- Ommen SR et al. 2024 AHA/ACC/AMSSM/HRS/PACES/SCMR Guideline for the Management of
  Hypertrophic Cardiomyopathy. DOI10.1161/CIR.0000000000001250. Recomendações de FA
  clínica/subclínica, DOAC e ablação conferidas. https://www.ahajournals.org/doi/pdf/10.1161/CIR.0000000000001250
- 'Joglar JA et al. 2023 ACC/AHA/ACCP/HRS Guideline for the Diagnosis and Management
  of Atrial Fibrillation. DOI10.1161/CIR.0000000000001193. Exceções para DOAC: estenose
  mitral moderada/grave e prótese mecânica.'
legacy_source: 'Documento novo. Busca anti-colisão em content/Cardiomiopatias/**/*.md,
  content/**/*.md, doencas/metadados.json, doencas/fragmentos/*.json e doencas/correcoes/*.json
  confirmou que fibrilação atrial (FA) na cardiomiopatia hipertrófica (CMH) nunca
  recebeu documento dedicado: a recomendação de anticoagulação independente do CHA₂DS₂-VASc
  aparece apenas como uma frase isolada dentro do documento-guarda-chuva ESC 2023
  completo (seção ''Manejo fibrilacao atrial em cmh'') e como campos estruturados
  pontuais em doencas/fragmentos/cardiomiopatia-hipertrofica.json (red flags, special_populations,
  assistant_rules), sem síntese própria sobre mecanismo, risco de trombo residual,
  escolha de anticoagulante ou desfechos de ablação nessa população específica. Os
  ângulos sugeridos de CMH e gravidez e de exercício físico na CMH já estão amplamente
  cobertos por múltiplos documentos existentes (ex.: cardiomiopatia-hipertrofica-na-gestacao-manejo-do-betabloqueador-e-conduta-no-trabalho-de-parto.md,
  cardiomiopatia-hipertrofica-na-gestacao-desfechos-maternos-e-fetais-no-ropac.md,
  fluxograma-cardiomiopatia-hipertrofica-com-lvoto-descompensada-na-gestacao.md e
  cardiomiopatia-hipertrofica-exercicio-esporte-competitivo.md, este último já citando
  meta-análise de 2026), e a cardiomiopatia dilatada de etiologia nutricional já tem
  documentos próprios por deficiência específica (tiamina, selênio, cobre, carnitina,
  hemocromatose, hipocalcemia), de modo que uma nova síntese nutricional genérica
  duplicaria conteúdo. FA na CMH, em contraste, é tema com produção científica muito
  recente e ainda não sintetizada no acervo — busca em PubMed (via NCBI eutils) em
  01/09/2026 retornou mais de dez artigos de 2026 sobre o tema, incluindo coorte retrospectiva
  sobre DOAC versus varfarina, estudo de fatores de risco para trombo de átrio esquerdo,
  artigo mecanístico e editorial definindo FA-CMH como entidade clínica distinta,
  e coorte nacional de recorrência pós-ablação — nenhum desses PMIDs constava previamente
  em source_refs de qualquer documento do repositório.'
...
- DOAC é a primeira opção quando elegível. Prótese mecânica ou estenose mitral moderada/grave exigem estratégia com antagonista da vitaminaK. Ajustar por função renal e interações.
