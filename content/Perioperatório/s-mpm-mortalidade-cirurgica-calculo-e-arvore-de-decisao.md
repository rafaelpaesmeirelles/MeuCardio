...
summary: "Modelo simples de 9 pontos para mortalidade global em 30 dias, mantido separado dos escores cardíacos."
source_refs:
...
A classe de risco do procedimento no S-MPM foi empiricamente derivada e não é automaticamente intercambiável com as classificações ESC/AHA. Se o procedimento não puder ser enquadrado com segurança pela metodologia original: **VERIFICAÇÃO HUMANA NECESSÁRIA**.