...
review_note: "Produção científica assistida (Claude, 26/08/2026); pendente de revisão independente e validação médica final. Conferido nesta sessão: texto integral da 2018 ESC Guidelines for the diagnosis and management of syncope (seções 4.2.2.1, Tabelas 3 e 8, seção 5.3 com a tabela de recomendações para tratamento da hipotensão ortostática, lidas em cópia PDF hospedada pela EUSEM); Practical Instructions da mesma diretriz (definições de HO inicial e tardia, texto integral em PDF hospedado pelo GIMSI); texto integral de Gibbons et al. 2017 (PMC5533816); bulas DailyMed de midodrina, fludrocortisona e droxidopa (Northera). Freeman 2011 só teve o registro PubMed conferido via E-utilities, sem abstract no registro; as definições atribuídas a ele foram lidas no texto da ESC 2018 que o adota. Derivado dos documentos do acervo hipotensao-ortostatica-e-sindrome-de-taquicardia-postural-pots-diagnostico-diferencial, fluxograma-sincope-reflexa-versus-cardiaca-diagnostico-diferencial, fluxograma-sincope-idoso-investigacao-diferenciada e fluxograma-hipertensao-no-idoso-e-no-fragil-quando-iniciar-alvo-e-desintensificacao-esc-2024. Verificação adversarial (Claude, 26/08/2026), com as fontes reabertas (PDF ESC 2018 e Practical Instructions via pdftotext, Gibbons 2017 via Europe PMC XML, bulas DailyMed, Crossref e PubMed): DOIs, PMIDs, classes, doses e cortes conferidos; corrigida a afirmação de que a medida sentado-em pé seria menos sensível (Gibbons só a chama de alternativa aceitável); folha da hipertensão supina/insuficiência cardíaca reescrita para cobrir o ramo de insuficiência cardíaca (ESC 2018 e bula: fludrocortisona contraindicada na hipertensão e na IC, midodrina contraindicada em cardiopatia grave); acrescentada a ressalva de marca-passo/arritmia ao critério de FC (Gibbons 2017). Mantida a sinalização VERIFICAÇÃO HUMANA NECESSÁRIA sobre sal versus sódio."
source_refs:
...
| Hidratação e sal | Classe I, nível C | 2 a 3 L de líquido e 10 g de cloreto de sódio ao dia na ausência de hipertensão (ESC); Gibbons: mínimo 2 L, até 1 a 2 colheres de chá de sal ao dia, citadas como 2,3 a 4,6 g — VERIFICAÇÃO HUMANA NECESSÁRIA quanto a sal versus sódio; bolo de 500 mL de água em 5 min eleva a sistólica em cerca de 30 mmHg |
...
- Quantidade de sal em Gibbons 2017: o texto extraído registra "1 a 2 colheres de chá (2,3 a 4,6 g) de sal por dia", valor que parece corresponder a sódio, não a cloreto de sódio — VERIFICAÇÃO HUMANA NECESSÁRIA antes de citar ao paciente; a ESC fala em 10 g de cloreto de sódio.
