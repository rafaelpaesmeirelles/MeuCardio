...
- O alvo sistólico de 120–129 mmHg quando tolerado vem do texto da seção 8.5 da ESC 2024. O documento não atribui classe ou nível próprios a detalhes das tabelas de fragilidade e hipotensão ortostática que não são reproduzidos.
