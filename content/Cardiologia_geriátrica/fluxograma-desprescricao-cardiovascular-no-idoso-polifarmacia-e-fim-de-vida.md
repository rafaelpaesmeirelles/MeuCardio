...
review_note: "Produção científica assistida (Claude, 26/08/2026); pendente de revisão independente e validação médica final. Conferido nesta sessão: texto integral de Kutner 2015 (PMC4618294), do ASPREE 2018 (PMC6289056), das tabelas cardiovasculares e da seção de uso pretendido dos Critérios de Beers 2023 (PMC12478568) e do artigo do STOPP/START v3 (PMC10447584, sem o apêndice com a redação dos critérios); documentos do acervo de que derivou: polifarmacia-cardiovascular-no-idoso-cascata-de-prescricao-e-desprescricao, estatina-em-prevencao-primaria-no-muito-idoso-o-que-prosper-e-a-metanalise-ctt-mostram, aspirina-em-prevencao-primaria-no-idoso-saudavel-o-ensaio-aspree, fluxograma-hipertensao-no-idoso-e-no-fragil-quando-iniciar-alvo-e-desintensificacao-esc-2024 e desprescricao-de-medicamentos-cardiovasculares-na-polifarmacia-consenso-cientifico-aha-2026. O fluxograma de reconciliação medicamentosa foi lido e não é duplicado: aquele trata de discrepância na transição de cuidado, este de retirada deliberada de fármaco. Verificação adversarial (Claude, 26/08/2026): todos os números de Kutner 2015, ASPREE 2018, Beers 2023 e STOPP/START v3 conferidos contra o texto integral no PMC; DOIs e PMIDs das quatro fontes conferidos no Crossref e no PubMed; números da CTT 2019, da mortalidade do ASPREE e da ESC 2024 conferidos nos documentos do acervo citados. Correções: a Classe IIb, nível B da ESC/EAS 2019 estava atribuída ao documento de estatina/CTT, que não a contém — passou a apontar para metas-terapeuticas-cardiovasculares-no-muito-idoso, onde está com citação literal; a folha C4 ganhou a ressalva de reduzir dose do pilar da IC antes de retirá-lo, porque o paciente com IC que cai chega a C4 sem passar por D6; a folha C7 passou a encaminhar à avaliação da estatina de prevenção primária, porque o paciente pode usar aspirina e estatina; corte de polifarmácia de 5 fármacos ou mais marcado como convencional (não conferido em fonte). A margem de não inferioridade e a proporção prevenção primária/secundária do Kutner continuam não localizadas no texto integral acessível — mantidas como VERIFICAÇÃO HUMANA NECESSÁRIA. Todos os 7 links do Tudo com Tudo apontam para slugs existentes."
source_refs:
...
flowchart TD
  ...
  D2 -->|"Sim"| C1(["Suspender estatina, ensaio Kutner 2015<br/>suspender aspirina de prevenção primária<br/>relaxar alvo pressórico, retirar um agente por vez"])
...
A revisão que abre a árvore vale para todos os ramos e por isso não é um nó: listar tudo, inclusive venda livre e suplementos; perguntar, item a item, se a indicação ainda existe; e cruzar a lista com as duas ferramentas validadas. O STOPP/START versão 3 (O'Mahony 2023) tem 190 critérios — 133 STOPP, de fármacos a evitar, e 57 START, de omissões a corrigir —, validados por 11 médicos de 8 países europeus em 4 rodadas Delphi; o sistema cardiovascular tem 21 critérios STOPP e 11 START, e há uma seção própria de fármacos que aumentam o risco de queda com 12 critérios STOPP. A redação literal de cada critério está em apêndice não acessado nesta sessão — VERIFICAÇÃO HUMANA NECESSÁRIA antes de citar o texto de um critério específico.
...
A conclusão dos autores é que suspender a estatina é seguro e pode trazer benefício em qualidade de vida, menos fármacos não estatina e menor custo. O limite do intervalo de confiança superior (10,5 pontos) não fechou formalmente a margem de não inferioridade pré-especificada — o valor dessa margem não foi conferido nesta sessão, VERIFICAÇÃO HUMANA NECESSÁRIA. A proporção de participantes em prevenção primária versus secundária também não foi conferida; a conduta C1 aplica o achado à estatina de prevenção primária e ao paciente em cuidado paliativo, que é a população do ensaio. O mesmo raciocínio de "benefício que só se acumula em anos" alcança a aspirina de prevenção primária e o alvo pressórico intensivo — a ESC 2024 lista expectativa de vida limitada entre as quatro situações em que o alvo de 120–129 mmHg deixa de ser o ponto de partida, detalhado em fluxograma-hipertensao-no-idoso-e-no-fragil-quando-iniciar-alvo-e-desintensificacao-esc-2024. O que controla sintoma (diurético, nitrato, controle de frequência) fica; a desativação do choque do CDI é conversa própria, em marca-passo-e-cdi-no-muito-idoso-indicacao-e-desativacao-em-fim-de-vida.
...
- Redação literal dos critérios STOPP/START v3 cardiovasculares e de risco de queda: apêndice não acessado — VERIFICAÇÃO HUMANA NECESSÁRIA antes de citar um critério pelo texto.
- Kutner 2015: margem de não inferioridade pré-especificada e proporção de prevenção primária versus secundária não conferidas nesta sessão — VERIFICAÇÃO HUMANA NECESSÁRIA.
