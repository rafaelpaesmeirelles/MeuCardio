...
kind: fluxograma
fonte_producao: grok
summary: 'Árvore ambulatorial de destino: gate de alto risco ESC/ECG/trauma/isquemia para PS; braço ortostático e braço equívoco com retorno precoce — sem
  doses.'
...
Prosa: [[sinalizadores-ambulatoriais-queda-sincope-idoso-quando-encaminhar](/biblioteca/sinalizadores-ambulatoriais-queda-sincope-idoso-quando-encaminhar)](/biblioteca/sinalizadores-ambulatoriais-queda-sincope-idoso-quando-encaminhar). Emergência: [[sincope-e-queda-no-idoso-estratificacao-de-risco-na-emergencia](/biblioteca/sincope-e-queda-no-idoso-estratificacao-de-risco-na-emergencia)](/biblioteca/sincope-e-queda-no-idoso-estratificacao-de-risco-na-emergencia).
...
flowchart TD
 ...
 I0 --> D1{"Há alarme de PS?<br/>esforço ou supina / palpitações → evento<br/>ECG de risco / BAV / pausas / isquemia<br/>trauma craniano em anticoagulado / sangramento<br/>instabilidade incerta / hipotensão persistente<br/>equivalente isquêmico (dispneia/dor/edema)"}
