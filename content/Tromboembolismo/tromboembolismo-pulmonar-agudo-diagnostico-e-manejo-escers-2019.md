---
title: "Tromboembolismo Pulmonar Agudo: Diagnóstico e Manejo (ESC/ERS 2019)"
slug: tromboembolismo-pulmonar-agudo-diagnostico-e-manejo-escers-2019
theme: "Tromboembolismo"
kind: protocolo
review_status: revisado
source_refs: ["Konstantinides SV, Meyer G, Becattini C, et al; ESC Scientific Document Group. 2019 ESC Guidelines for the diagnosis and management of acute pulmonary embolism developed in collaboration with the European Respiratory Society (ERS). Eur Heart J. 2020;41(4):543-603. DOI: 10.1093/eurheartj/ehz405. PMID: 31504429.", "Pruszczyk P, Konstantinides S. Where to treat patients with acute pulmonary embolism? Kardiol Pol. 2020;78(1):15-19. DOI: 10.33963/KP.15143. PMID: 31939451.", "Jiménez D, Aujesky D, Moores L, et al; RIETE Investigators. Simplification of the pulmonary embolism severity index for prognostication in patients with acute symptomatic pulmonary embolism. Arch Intern Med. 2010;170(15):1383-1389. DOI: 10.1001/archinternmed.2010.199. PMID: 20696966.", "Meyer G, Vicaut E, Danays T, et al; PEITHO Investigators. Fibrinolysis for patients with intermediate-risk pulmonary embolism. N Engl J Med. 2014;370(15):1402-1411. DOI: 10.1056/NEJMoa1302097. PMID: 24716681.", "Chatterjee S, Chakraborty A, Weinberg I, et al. Thrombolysis for pulmonary embolism and risk of all-cause mortality, major bleeding, and intracranial hemorrhage. JAMA. 2014;311(23):2414-2421. DOI: 10.1001/jama.2014.5990. PMID: 24938564.", "Creager MA, Barnes GD, Giri J, et al. 2026 AHA/ACC/ACCP/ACEP/CHEST/SCAI/SHM/SIR/SVM/SVN Guideline for the Evaluation and Management of Acute Pulmonary Embolism in Adults. J Am Coll Cardiol. 2026;87(13):1626-1710. DOI: 10.1016/j.jacc.2025.11.005. PMID: 41712898.", "Correction to the 2026 multisociety acute pulmonary embolism guideline. Circulation. 2026;154(2):e24. DOI: 10.1161/CIR.0000000000001462. PMID: 42441758."]
review_note: "Revisão de 26/08/2026: a pendência humana sobre as categorias AHA/ACC 2026 foi resolvida pelo texto integral primário em JACC e pelo material oficial AHA/ACC, incluindo a errata de 13/07/2026. Confirmadas as categorias A-E, subcategorias C1-C3, D1-D2 e E1-E2 e o modificador respiratório R. O protocolo ESC 2019 foi preservado como referência histórica e conectado à diretriz AHA/ACC 2026 já existente, sem criar duplicata."
...
## Definicao
Importante problema de saúde pública; diretriz de 2019 da ESC em colaboração com a European Respiratory Society (ERS) sucede versões anteriores publicadas em 2000, 2008 e 2014

## Terminologia atualizada
Termos como 'provocado' versus 'não provocado' para TEP/tromboembolismo venoso (TEV) não são mais suportados pela diretriz; em vez disso, propõe-se uso de termos como 'fator de risco reversível', 'qualquer fator de risco persistente', ou 'nenhum fator de risco identificável'

## D dimero
Os limiares de D-dímero devem ser ajustados por idade e probabilidade pré-teste, em vez de valores fixos

## Definicao instabilidade hemodinamica
Agora claramente definida como presença de parada cardíaca necessitando ressuscitação, choque obstrutivo, ou hipotensão persistente não causada por outra patologia

## Algoritmo risco adaptado
Algoritmo revisado de manejo ajustado ao risco considera gravidade clínica, disfunção de ventrículo direito e outras comorbidades, com ênfase em equipes multidisciplinares (Classe IIa) e estratificação de risco precoce

## Tratamento fase aguda
- **alto risco**: Trombólise IV de resgate agora é recomendação Classe I (previamente IIa); terapia de remoção intervencionista de trombo (baseada em cateter ou cirúrgica) agora é Classe IIa (previamente IIb) em TEP com deterioração hemodinâmica
- **intermediario baixo risco**: Anticoagulação inicial conforme estratificação de risco; suporte hemodinâmico e respiratório conforme necessário
- **fonte**: diretriz ESC/ERS 2019 citada em `source_refs`
...
## Seguimento
Modelo de cuidado integrado hospitalar-ambulatorial 3-6 meses após o evento, além de referenciar pacientes sintomáticos com defeitos de perfusão incompatíveis (em cintilografia V/Q) por mais de 3 meses pós-TEP a centro especializado em hipertensão pulmonar tromboembólica crônica (CTEPH), é recomendação Classe I
...
- Aplicar valor fixo de D-dímero sem ajuste por idade e probabilidade pré-teste
...
## Diretriz americana de 2026 — categorias confirmadas
A diretriz **de novo** AHA/ACC multisocietária de 2026 foi conferida no texto
integral publicado no JACC, não apenas no resumo. Ela introduz cinco categorias
clínicas, escolhidas pelo achado de maior gravidade e reavaliadas ao longo do
tempo:

- **A**: TEP incidental e assintomático;
- **B**: TEP sintomático com baixo escore clínico — por exemplo, PESI ≤85,
  sPESI = 0 ou Hestia = 0;
- **C**: sintomático com escore clínico elevado. **C1** tem VD e biomarcadores
  normais; **C2**, VD anormal ou ao menos um biomarcador anormal; **C3**, VD
  anormal e ao menos um biomarcador anormal;
- **D**: falência cardiopulmonar incipiente. **D1** inclui hipotensão transitória
  ou recorrente sem hipoperfusão; **D2** acrescenta marcador de hipoperfusão ou
  disfunção de órgão;
- **E**: falência cardiopulmonar estabelecida. **E1** corresponde a hipotensão
  persistente/choque; **E2**, choque refratário ou parada cardíaca sem retorno da
  circulação espontânea após 30 minutos.

O modificador **R** sinaliza comprometimento respiratório proeminente e pode
ser acrescentado à categoria. Em geral, A e B podem ser manejadas fora do
hospital ou com alta precoce quando não há outro impedimento; C-E requerem
internação. Terapias avançadas são razoáveis em E1 e podem ser consideradas em
D1-D2, mas **disfunção de VD isolada em categoria C não autoriza reperfusão
automática**.

Essa classificação não deve ser convertida mecanicamente nas quatro classes
ESC 2019. A descrição completa está em [AHA/ACC 2026: TEP agudo — categorias
clínicas, anticoagulação e terapias avançadas](aha-acc-2026-tep-agudo-categorias-clinicas-anticoagulacao-e-terapias-avancadas.md).
...
- [Diretriz AHA/ACC 2026 — categorias clínicas e terapias avançadas](aha-acc-2026-tep-agudo-categorias-clinicas-anticoagulacao-e-terapias-avancadas.md)
...
- [DOAC no TEV agudo — ensaios pivotais](doac-no-tratamento-do-tev-agudo-amplify-einstein-pe-re-cover-e-hokusai-vte.md)
