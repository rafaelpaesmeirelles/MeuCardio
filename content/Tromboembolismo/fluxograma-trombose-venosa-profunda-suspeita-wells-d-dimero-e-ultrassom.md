...
review_note: "Produção científica assistida (Claude, 26/08/2026); pendente de revisão independente e validação médica final. Lidos na íntegra nesta sessão: diretriz ASH 2018 de diagnóstico de TEV (texto completo via PMC6258916 — recomendações 5a, 5b, 6a, 6b, 7a e 7b, definição de prevalência por probabilidade pré-teste e definição de ultrassonografia seriada), sumário executivo da CHEST 2021 (PDF do texto completo — declarações 1, 2, 14 e 15), abstract do Wells 2003 NEJM (via PubMed E-utilities) e tabela do escore de Wells reproduzida em van Dam 2020 J Thromb Haemost (texto completo via PMC7497055). Derivado dos documentos já publicados no acervo trombose-venosa-profunda-diagnostico-e-tratamento e trombose-venosa-profunda-distal-isolada-duracao-da-anticoagulacao-e-vigilancia. O texto integral da CHEST 2021 (fatores de risco de extensão da TVP distal no suplemento) e a recomendação de tratamento domiciliar da TVP não foram lidos e estão marcados no corpo. Verificação adversarial (26/08/2026): DOIs e PMIDs conferidos no Crossref e no PubMed; números do Wells 2003 conferidos no abstract; recomendações ASH 5a/5b/6a/7a/7b e prevalências conferidas no PMC6258916; declarações 1, 2, 14 e 15 da CHEST 2021 conferidas no PDF do sumário executivo; tabela de Wells conferida em PMC7497055. Correções: força/certeza da recomendação 5a desdobrada em etapa D-dímero (forte, moderada) e etapa ultrassonografia (condicional, muito baixa); páginas do sumário executivo acrescentadas; link do Tudo com Tudo para o fluxograma de TEP (ESC 2019) trocado pelo fluxograma de escolha do anticoagulante no TEV, folha para onde a árvore encaminha."
source_refs:
...
Sobre o tratamento ambulatorial: no sumário executivo da CHEST 2021 lido nesta sessão, a recomendação formal de tratamento fora do hospital (declaração 14, forte, certeza baixa) é enunciada para TEP de baixo risco, com quatro condições no comentário — estabilidade clínica com boa reserva cardiopulmonar, ausência de contraindicação como sangramento recente, doença renal ou hepática grave ou plaquetas abaixo de 50.000/mm3, adesão esperada e paciente sentindo-se bem o bastante para ser tratado em casa — além de um sistema de acompanhamento e acesso rápido em caso de piora. A recomendação equivalente para TVP de perna vem da edição anterior da diretriz e não foi lida nesta sessão: VERIFICAÇÃO HUMANA NECESSÁRIA antes de citar sua força e certeza. Na prática, os mesmos critérios se aplicam à decisão de tratar a TVP em casa.
...
A lista de fatores de risco para extensão está no texto completo e no suplemento da CHEST 2021, que não foram lidos nesta sessão: VERIFICAÇÃO HUMANA NECESSÁRIA para os critérios exatos (extensão e diâmetro do trombo, proximidade das veias proximais, ausência de fator provocador reversível, câncer ativo, TEV prévio, internação, D-dímero positivo são os candidatos habituais). A evidência quantitativa por trás da escolha, incluindo a metanálise de 2025 e o ensaio japonês de rivaroxabana, está em trombose-venosa-profunda-distal-isolada-duracao-da-anticoagulacao-e-vigilancia.
...
- Recomendação de tratamento domiciliar da TVP de perna: força e certeza não conferidas nesta sessão (VERIFICAÇÃO HUMANA NECESSÁRIA), porque o sumário executivo da CHEST 2021 lido aqui só enuncia a declaração para TEP de baixo risco.
- Fatores de risco para extensão da TVP distal isolada: lista exata pendente de leitura do texto completo e do suplemento da CHEST 2021 (VERIFICAÇÃO HUMANA NECESSÁRIA).
