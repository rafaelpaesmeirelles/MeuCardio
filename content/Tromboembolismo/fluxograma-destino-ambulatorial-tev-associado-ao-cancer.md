...
kind: fluxograma
fonte_producao: grok
summary: "Árvore de destino no CAT: urgência; specialty por risco hemorrágico/renal/interações; TEP estratificado antes de alta; e rede segura obrigatória em TEV confirmado."
review_status: revisado
review_note: "Revisão clínica final 08/09/2026. Adicionados gate de risco de TEP, disfunção renal grave, separação entre confirmação diagnóstica e segurança da rede, e rota supervisionada para TEV confirmado sem acesso seguro."
source_refs:
...
flowchart TD
  ...
  D2 -->|"Não"| C2(["Completar diagnóstico no fluxo apropriado<br/>PS se surgir alarme"])

  D2 -->|"Sim"| D3{"É TEP confirmado/incidental?"}
  D3 -->|"Sim"| P3["Estratificar PESI/sPESI<br/>+ VD/biomarcadores quando indicados"]
  ...
  D5 -->|"Sim"| C4(["Hematologia/oncologia antes de fechar plano"])
