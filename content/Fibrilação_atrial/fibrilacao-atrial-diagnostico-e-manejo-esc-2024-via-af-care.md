...
Novas recomendações específicas para dispositivos de oclusão, ampliando a opção terapêutica de redução de risco tromboembólico em quem tem contraindicação à anticoagulação de longo prazo. **Parcialmente resolvido em 30/07/2026**: os dois ensaios pivotais do dispositivo (PROTECT AF e PREVAIL, com números completos) estão em `oclusao-do-apendice-atrial-esquerdo-protect-af-e-prevail.md`, nesta mesma pasta. VERIFICAÇÃO HUMANA NECESSÁRIA permanece só para os critérios de indicação e a classe exata da recomendação **desta diretriz especificamente** (ESC 2024/AF-CARE) — não localizados em fonte de acesso aberto nesta sessão.
