...
review_note: "Produção científica assistida (Claude, 26/08/2026); pendente de revisão independente e validação médica final. Fontes lidas na íntegra nesta sessão a partir do PDF completo das duas diretrizes: ESC 2023 SCA (seção 6.5 'Antiplatelet therapy in patients requiring oral anticoagulation', Figura 12 e Recommendation Tables 5 e 6) e ESC 2024 FA (seção 9.2 'AF-CARE in acute and chronic coronary syndromes', Figura 14 e Recommendation Table 24). Cada duração, classe e nível de recomendação citados foi conferido contra o texto dessas tabelas. PMIDs 37622654 e 39210723 conferidos por PubMed E-utilities (título, revista, volume e páginas batendo). Derivado do documento augustus-terapia-antitrombotica-apos-sca-ou-icp-na-fibrilacao-atrial.md, já publicado nesta pasta; o fluxograma de DAPT sem FA (fluxograma-duracao-e-desescalonamento-da-dapt-apos-icp.md) foi lido para não repetir seus ramos. Dois pontos marcados para verificação humana: a frase da ESC 2024 sobre tripla terapia em 'pacientes sem diabetes' e a extensão até 3 meses no diabético, que a diretriz de FA atribui (referência 207) à diretriz ESC 2023 de doença cardiovascular no diabetes, não lida nesta sessão. Verificação adversarial (26/08/2026) com os dois PDFs abertos: durações, classes e níveis conferidos linha a linha nas Recommendation Tables 5 e 6 (ESC 2023) e 24 (ESC 2024) e nas Figuras 12 e 14; DOIs conferidos no Crossref. Correções aplicadas: a fonte citada para a tripla de até 3 meses no diabético era erroneamente atribuída à diretriz ESC 2024 de SCC (a lista de referências da ESC 2024 de FA identifica a 207 como a diretriz ESC 2023 de diabetes); acrescentada a exceção da prótese mecânica em posição mitral ao alvo de INR 2,0-2,5 (texto da seção 6.5.1 da ESC 2023); a frase sobre escores de sangramento foi alinhada à recomendação literal da ESC 2024 (não usar escores para decidir iniciar ou suspender o anticoagulante, Classe III)."
source_refs:
...
flowchart TD
  ...
  P4 --> C6
  D5 -->|"Não"| C7
  D1 -->|"Doença coronariana estável, sem SCA nem ICP<br/>nos últimos 12 meses"| C8
...
- **Diabetes e extensão da tripla até 3 meses.** O texto da ESC 2024 diz que a tripla curta de até 1 semana "é recomendada para todos os pacientes sem diabetes após SCA ou ICP" e que, no diabético com stent, prolongar a tripla com AAS em dose baixa, clopidogrel e anticoagulante "até 3 meses pode ser de benefício se o risco trombótico supera o hemorrágico", citando como fonte (referência 207) a diretriz ESC 2023 de doença cardiovascular no diabetes (Marx N et al.). Essa diretriz não foi lida nesta sessão e a frase não aparece na Recommendation Table 24 com classe própria — VERIFICAÇÃO HUMANA NECESSÁRIA antes de usar o prazo de 3 meses como ramo de conduta. A árvore mantém o teto de 1 mês, que é o que as tabelas de recomendação das duas diretrizes formalizam.
