...
review_note: "Irmão do protocolo sinalizadores-ambulatoriais-ait-deficit-focal-estenose-carotidea-quando-encaminhar (07/09/2026). ESC 2024 PMID 39210722; AHA/ASA 2021 PMID 34024117. Além de #833 CLTI/AAA."
source_refs:
...
Prosa: [`sinalizadores-ambulatoriais-ait-deficit-focal-estenose-carotidea-quando-encaminhar`](sinalizadores-ambulatoriais-ait-deficit-focal-estenose-carotidea-quando-encaminhar.md). Janela 14 dias: [`estenose-carotidea-sintomatica-janela-de-14-dias-destino-ambulatorial`](estenose-carotidea-sintomatica-janela-de-14-dias-destino-ambulatorial.md). Hub: [`estenose-de-carotida-diagnostico-e-indicacao-de-revascularizacao-esc-2024`](estenose-de-carotida-diagnostico-e-indicacao-de-revascularizacao-esc-2024.md).
...
flowchart TD
  ...
  D3 -->|"Sim"| C2(["Vascular/neurovascular PRIORITÁRIO<br/>Preservar janela ≤14 dias se CEA/CAS<br/>indicados (ESC 2024)"])
...
| AIT/AVC menor recente + estenose ipsilateral ≥50% | Vascular/neurovascular prioritário (≤14 dias se indicado) |
