...
- **fonte**: **Revisado pelo Rafael em 30/07/2026.** A origem foi confirmada nesta sessão por múltiplas fontes independentes (revisão de uso prático do FRS no Canadá, PMC3076470; e material de adaptação da diretriz de 2016 para farmacêuticos, PMC5684982): a Canadian Cardiovascular Society usa e chama explicitamente de **"Modified Framingham Risk Score"** esta versão em pontos com colesterol em mmol/L, atribuída às diretrizes canadenses de dislipidemia (Genest J et al. 2009; Anderson TJ et al., Can J Cardiol. 2016;32(11):1263-1282) — **não ao modelo de D'Agostino RB Sr 2008**, que é a referência do FRS geral desta página e **não usa tabela de pontos simples** (usa equação contínua). Esta tabela pertence a uma família diferente da citada no `source_refs` geral
