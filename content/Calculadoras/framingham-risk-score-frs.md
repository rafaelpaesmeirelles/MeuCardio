...
source_refs: ["D'Agostino RB Sr, Vasan RS, Pencina MJ, et al. General cardiovascular risk profile for use in primary care: the Framingham Heart Study. Circulation. 2008;117(6):743-753. DOI: 10.1161/CIRCULATIONAHA.107.699579. PMID: 18212285", "Fontenelle LF, Sarti TD, Quinte GC, Almeida APSC, Mill JG. Agreement between Framingham, Pooled Cohort Equations, and Globorisk-LAC in the Estimation of Cardiovascular Risk in Brazil, 2013. Arq Bras Cardiol. 2025;122(6):e20240405. DOI: 10.36660/abc.20240405. PMID: 40736124", "Practical use of the Framingham risk score in primary prevention: Canadian perspective. PMC3076470 — confirma que a CCS chama sua adaptação de 'Modified Framingham Risk Score', atribuída a Genest J et al. 2009", "2016 Guidelines for the management of dyslipidemia and the prevention of cardiovascular disease in adults by pharmacists (material de adaptação da diretriz CCS 2016). PMC5684982 — confirma o uso do 'Modified FRS' pela CCS, sem reproduzir a tabela de pontos"]
...
- **fonte**: **Parcialmente resolvido em 30/07/2026.** A origem provável foi confirmada — não a exatidão numérica ponto a ponto. Múltiplas fontes independentes (revisão de uso prático do FRS no Canadá, PMC3076470; e material de adaptação da diretriz de 2016 para farmacêuticos, PMC5684982) confirmam que a Canadian Cardiovascular Society usa e chama explicitamente de **"Modified Framingham Risk Score"** uma versão em pontos com colesterol em mmol/L, atribuída às diretrizes canadenses de dislipidemia (Genest J et al. 2009; Anderson TJ et al., Can J Cardiol. 2016;32(11):1263-1282) — **não ao modelo de D'Agostino RB Sr 2008**, que é a referência do FRS geral desta página e **não usa tabela de pontos simples** (usa equação contínua). Isso confirma que esta tabela pertence a uma família diferente da citada no `source_refs` geral. **O que não foi possível verificar nesta sessão**: os valores numéricos ponto a ponto contra o PDF oficial da CCS, que é baseado em imagem/gráfico vetorial e não permite extração de texto, e o texto completo da diretriz de 2016 (Can J Cardiol) ficou bloqueado para acesso. VERIFICAÇÃO HUMANA NECESSÁRIA, agora restrita à conferência numérica exata contra o PDF oficial da CCS (ccs.ca/frs/) ou o app oficial da diretriz — não à origem, que está identificada
...
## Fonte
Canadian Cardiovascular Society — **confirmado em 30/07/2026** que as tabelas de pontos em mmol/L acima vêm da adaptação canadense do escore ("Modified Framingham Risk Score", nas diretrizes de dislipidemia da CCS), não do modelo de D'Agostino RB Sr et al., Circulation 2008;117:743-753, que é a referência do FRS geral desta página. A conferência numérica ponto a ponto contra o PDF oficial da CCS continua pendente — ver a marcação de verificação na seção "Pontuacao idade".
