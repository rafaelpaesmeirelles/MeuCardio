...
review_note: "Revisão final 08/09/2026: estabilidade estabelecida antes de retorno; arritmia/TVP no gate; reavaliar alarmes após exames; suspeita nova exige investigação rápida sem esperar dias."
source_refs:
...
flowchart TD
  ...
  DP -->|"Não / incerta"| C1
  DP -->|"Sim"| C2(["Retorno ambulatorial 24–72 h<br/>Orientação escrita de alarmes<br/>(≤7 dias se brando e suporte OK)"])

  D2 -->|"Não / estável"| D3{"PPCM/suspeita sem pregnancy<br/>heart team / cardiologia ativa<br/>ou transição do 1º ano incompleta?"}

  D3 -->|"Sim"| C3(["Referência pregnancy heart team<br/>/ cardiologia + plano ACC 2026<br/>até 12 semanas e 1º ano"])
  ...
  D4 -->|"Sim"| C6(["Manter retorno 24–72 h<br/>Não protocolar doses neste fluxograma"])
