...
review_note: "NIGHT-B06-REVIEW (2026-08-25): revisão editorial concluída após corrigir autores, PMIDs e a atribuição dos relatos pediátricos. Foi removida a regra SCN5A sem lastro no consenso; o fluxograma conserva apenas as recomendações efetivamente descritas pelo consenso pediátrico e não publica dose fixa de isoproterenol, betabloqueador ou quinidina."
---
