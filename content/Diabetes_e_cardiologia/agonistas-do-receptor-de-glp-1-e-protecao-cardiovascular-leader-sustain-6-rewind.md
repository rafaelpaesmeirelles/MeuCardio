...
## Definicao
O documento geral desta biblioteca sobre doença cardiovascular no diabetes (ESC 2023) já registra que agonistas do receptor de GLP-1 são recomendados para redução de risco cardiovascular, mas sem os números dos ensaios que sustentam essa recomendação. Este documento cobre os três ensaios pivotais de desfecho cardiovascular com agonistas de GLP-1 **em diabetes tipo 2** — distintos do estudo SELECT (nesta mesma pasta), que testou semaglutida em obesidade **sem** diabetes.

## Leader liraglutida
9.340 pacientes com diabetes tipo 2 e alto risco cardiovascular, randomizados para liraglutida ou placebo, seguimento mediano de 3,8 anos. Desfecho primário composto (morte cardiovascular, IAM não fatal ou AVC não fatal): **13,0% com liraglutida vs. 14,9% com placebo** (HR 0,87; IC95% 0,78-0,97; p<0,001 para não inferioridade, p=0,01 para superioridade). Morte cardiovascular isolada: 4,7% vs. 6,0% (HR 0,78; IC95% 0,66-0,93; p=0,007). Mortalidade por qualquer causa: 8,2% vs. 9,6% (HR 0,85; IC95% 0,74-0,97; p=0,02). IAM não fatal, AVC não fatal e hospitalização por IC foram numericamente menores com liraglutida, sem significância estatística isolada. Eventos adversos que mais levaram à descontinuação foram gastrointestinais.
...
- **retinopatia**: a piora de retinopatia com semaglutida no SUSTAIN-6 não tem contrapartida clara nos outros dois ensaios listados aqui — vale rastreio oftalmológico mais atento ao iniciar semaglutida, sobretudo em quem já tem retinopatia diabética
- **AVC**: a redução de AVC não fatal foi o componente mais forte no SUSTAIN-6, enquanto no LEADER a redução foi mais distribuída entre morte cardiovascular e mortalidade geral

## Armadilhas clinicas
- Citar o estudo SELECT (obesidade sem diabetes) como se fosse evidência de desfecho cardiovascular em diabetes tipo 2 — são populações e, em parte, desenhos diferentes
- Tratar os três ensaios como comparação direta entre liraglutida, semaglutida e dulaglutida — nenhum foi desenhado para isso
- Iniciar semaglutida em paciente com retinopatia diabética avançada sem reforçar o acompanhamento oftalmológico
- Assumir que a redução de eventos cardiovasculares se traduz em redução de mortalidade em todos os ensaios — no REWIND, a mortalidade por qualquer causa não atingiu diferença estatisticamente significativa
