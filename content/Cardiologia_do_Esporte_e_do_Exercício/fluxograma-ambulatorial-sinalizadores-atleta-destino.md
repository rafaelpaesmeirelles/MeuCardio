...
title: 'Fluxograma ambulatorial: sinalizadores no atleta — PS agora vs. restrição + investigação vs. individualizar
  participação com plano'
kind: fluxograma
theme: Cardiologia do Esporte e do Exercício
summary: 'Árvore ambulatorial de destino no atleta sintomático: gate de alarme para PS/suspensão imediata, braço
  de restrição com investigação dirigida, e braço de decisão compartilhada com educação de alarmes — sem duplicar
  o fluxograma de síncope no esforço.'
tags: []
source_refs:
