...
summary: 'Destino do atleta com PA elevada: emergência se houver lesão aguda de órgão-alvo; na ausência, confirmar
  PA, tratar e individualizar participação esportiva conforme modalidade, risco e diferenças entre recomendações
  ESC e AHA/ACC.'
tags: []
source_refs:
...
- **D2** = PA de repouso não controlada → individualizar participação por PA confirmada, modalidade e lesão de órgão-alvo. EAPC 2019/ESC 2020 são mais restritivas para competição com PA não controlada; AHA/ACC 2025 permite decisão individualizada na ausência de emergência. Não converter este ramo em liberação ou restrição universal.
