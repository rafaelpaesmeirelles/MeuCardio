...
## O ensaio randomizado prague csp — desfecho de funcao ventricular, nao de mortalidade
Curila K et al., Heart Rhythm. 2025;22(10):e894-e902 (PMID 40412596). Randomizado 1:1, indicação de marca-passo por doença de condução atrioventricular, seguimento de 12 meses:
...
## O estudo melos reloaded — sinal de sobrevida em coorte observacional pareada
...
## A metanalise de ensaios randomizados — o que ja e consistente entre estudos
...
- **FEVE**: melhora com CSP, diferença média +1,31% (IC95% 0,49 a 2,14; p<0,01) — pequena em magnitude, mas consistente
- **Duração do QRS estimulado**: mais estreito com CSP, diferença média -28,44 ms (IC95% -38,96 a -17,92; p<0,01)
- **Tempo de procedimento**: maior com CSP, diferença média +25,86 minutos (IC95% 23,09-28,63; p<0,01)
