---
title: "Fluxograma: Síndrome do QT longo congênito — diagnóstico e manejo (ESC 2022)"
slug: fluxograma-sindrome-do-qt-longo-congenito-diagnostico-e-manejo-esc-2022
theme: "Arritmias"
kind: fluxograma
summary: "Árvore de decisão da ESC 2022 para a síndrome do QT longo congênita fora da gestação: exclusão de causa adquirida, os três critérios diagnósticos (QTc ≥480 ms repetido, escore >3 ou variante patogênica), betabloqueador não seletivo para todo QT prolongado documentado, CDI após parada abortada e CDI ou denervação simpática esquerda quando há sintoma apesar do betabloqueador."
...
source_refs:
  - "Zeppenfeld K, Tfelt-Hansen J, de Riva M, et al. 2022 ESC Guidelines for the management of patients with ventricular arrhythmias and the prevention of sudden cardiac death. Eur Heart J. 2022;43(40):3997-4126. DOI: 10.1093/eurheartj/ehac262. PMID: 36017572. Tabela 10 e recomendações de LQTS conferidas no texto oficial em https://academic.oup.com/eurheartj/article/43/40/3997/6675633 e no slide set oficial da ESC."
  - "Wang G, Chu H, Zhao N. The Clinical Diagnosis and Management of Long QT Syndrome: Insights from the 2022 ESC Guidelines. Rev Cardiovasc Med. 2023;24(6):170. DOI: 10.31083/j.rcm2406170. PMID: 39077522. PMCID: PMC11264164. Texto integral lido em https://pmc.ncbi.nlm.nih.gov/articles/PMC11264164/ — reproduz literalmente as recomendações de diagnóstico, betabloqueador, mexiletina, CDI e denervação simpática da ESC 2022."
  - "Könemann H, Dagres N, Merino JL, et al. Spotlight on the 2022 ESC guideline management of ventricular arrhythmias and prevention of sudden cardiac death: 10 novel key aspects. Europace. 2023;25(5):euad091. DOI: 10.1093/europace/euad091. PMID: 37102266. PMCID: PMC10228619. Lido em https://pmc.ncbi.nlm.nih.gov/articles/PMC10228619/ — preferência por nadolol/propranolol, mexiletina promovida a classe I no LQT3, calculadora 1-2-3-LQTS-Risk."
  - "Alders M, Bikker H, Christiaans I. Long QT Syndrome. GeneReviews [Internet]. University of Washington, Seattle; atualização de 21/03/2024. Bookshelf ID: NBK1129. Tabela 1 (escore diagnóstico, adaptada de Schwartz & Crotti 2011 com modificação de Zeppenfeld et al. 2022) lida em https://www.ncbi.nlm.nih.gov/books/NBK1129/."
  - "Derivado de canalopatias-sindrome-do-qt-longo-e-sindrome-de-brugada-diagnostico-e-manejo.md (Arritmias) e de sindrome-do-qt-longo-congenita-na-crianca-escore-de-schwartz-genotipos-e-estratificacao-de-risco.md (Cardiologia pediátrica), já publicados no acervo."
---
...
```mermaid
flowchart TD
  R0["Suspeita de LQTS congênita: QTc prolongado em ECG,<br/>síncope arrítmica, história familiar ou<br/>rastreio de familiar de caso índice"]
  P1["Excluir causa secundária de QT longo: fármacos,<br/>hipocalemia, hipomagnesemia, hipocalcemia,<br/>bradicardia, isquemia. Repetir ECG de 12 derivações<br/>e calcular o escore diagnóstico"]
  D1{"Causa adquirida identificada<br/>e QTc normaliza após corrigi-la?"}
  C1(["QT longo adquirido: retirar o gatilho e corrigir<br/>eletrólitos — seguir o fluxograma de torsades<br/>e QT longo adquirido"])
  D2{"Critério diagnóstico presente: QTc de 480 ms ou mais<br/>em ECGs repetidos, escore diagnóstico acima de 3<br/>ou variante patogênica em gene de LQTS?"}
  D9{"QTc entre 460 e 479 ms em ECGs repetidos<br/>com síncope arrítmica e sem causa secundária?"}
  C9(["Diagnóstico de LQTS deve ser considerado:<br/>teste genético, aconselhamento e seguimento<br/>em centro com experiência em canalopatias"])
  C10(["Sem diagnóstico firmado: ECGs seriados, teste ergométrico<br/>com QTc no 4º minuto de recuperação, Holter<br/>e reavaliação do escore. Não rotular como LQTS"])
  P2["LQTS diagnosticada: teste genético e aconselhamento.<br/>Evitar fármacos que prolongam o QT, evitar e corrigir<br/>distúrbios eletrolíticos, evitar gatilhos do genótipo"]
  D3{"Parada cardíaca abortada?"}
  C2(["CDI somado a betabloqueador não seletivo,<br/>nadolol ou propranolol. Mexiletina se LQT3"])
  D4{"Prolongamento do QT documentado no ECG?"}
  C3(["Variante patogênica com QTc normal: betabloqueador<br/>deve ser considerado. Medidas gerais e seguimento"])
  P3["Betabloqueador não seletivo, nadolol ou propranolol.<br/>Mexiletina no LQT3 com QT prolongado.<br/>Calcular o risco arrítmico por genótipo e QTc<br/>antes de iniciar a terapia"]
  D5{"Síncope ou TV apesar de betabloqueador<br/>e terapia específica do genótipo?"}
  D6{"CDI contraindicado ou recusado?"}
  C4(["CDI. Denervação simpática cardíaca esquerda<br/>se choques múltiplos ou síncope por TV<br/>já com CDI e terapia plena"])
  C5(["Denervação simpática cardíaca esquerda"])
  D7{"Sintomático (síncope ou TV prévia) e betabloqueador<br/>ou terapia do genótipo não tolerados ou<br/>contraindicados na dose terapêutica?"}
  C6(["CDI ou denervação simpática cardíaca esquerda<br/>devem ser considerados"])
  D8{"Assintomático com perfil de alto risco<br/>pela calculadora 1-2-3-LQTS-Risk?"}
  C7(["CDI pode ser considerado, somado à terapia<br/>específica do genótipo"])
  C8(["Manter betabloqueador e medidas gerais.<br/>Seguimento clínico e rastreio de familiares<br/>de primeiro grau"])
...
O escore diagnóstico modificado da diretriz (tabela abaixo) soma os achados independentes. Só não se acumulam alternativas mutuamente exclusivas: usa-se uma única faixa de QTc, uma única categoria de síncope e, conforme a nota da tabela, não se atribuem pontos simultaneamente a torsades de pointes e síncope. Os demais critérios de ECG, história clínica, história familiar e genética podem ser somados quando presentes. A variante patogênica sozinha vale 3,5 pontos e, portanto, fecha o diagnóstico mesmo com QTc normal. A versão modificada da ESC 2022 retirou o item "surdez congênita"; a surdez segue como pista clínica da síndrome de Jervell e Lange-Nielsen, mas não pontua nesta tabela.
...
| Morte súbita inexplicada antes dos 30 anos em familiar de 1º grau | 0,5 |
...
- O item "morte súbita inexplicada antes dos 30 anos em familiar de 1º grau" vale 0,5 ponto na Tabela 10 do texto integral oficial da ESC 2022.
- O ramo D8 exige o resultado da calculadora validada 1-2-3-LQTS-Risk; este documento não reproduz nem substitui o algoritmo da ferramenta.
...
- A Tabela 10 foi conferida no texto integral oficial do European Heart Journal; as recomendações também foram comparadas com o slide set oficial da ESC.
