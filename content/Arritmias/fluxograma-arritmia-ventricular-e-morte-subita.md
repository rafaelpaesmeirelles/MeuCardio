...
legacy_source: "Atualização de segurança e revisão documental independente concluídas em 24/08/2026. A versão anterior aplicava a regra genérica 'instável = cardioversão sincronizada' antes de distinguir TV monomórfica de TV polimórfica e sugeria sulfato de magnésio no ramo de TV polimórfica sem QT longo. O texto foi alinhado às recomendações AHA 2025 e ESC 2022; parâmetros operacionais continuam sujeitos ao protocolo institucional."
---

# Arritmia ventricular e risco de morte súbita

> **STATUS DE CURADORIA:** `revisado`. Atualizado para separar corretamente **TV monomórfica** de **TV polimórfica** antes de escolher terapia elétrica. Energia, doses e sequências farmacológicas exigem validação no protocolo institucional antes de uso operacional.
