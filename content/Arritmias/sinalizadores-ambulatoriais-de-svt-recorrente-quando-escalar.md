...
review_note: "Lacuna ambulatorial em Arritmias além de TVNS (#839) — 07/09/2026. Anti-colisão: evita FA anticoag (#827/#852) e overnight #826–862. Fontes: ESC 2019 SVT PMID 31504425; ACC/AHA/HRS 2015 SVT PMID 26409259. Sem doses."
source_refs:
...
Não substitui:
- manejo agudo de TSV de QRS estreito — [`fluxograma-taquicardia-supraventricular-qrs-estreito-esc-2019`](fluxograma-taquicardia-supraventricular-qrs-estreito-esc-2019.md) e [`taquicardia-supraventricular-diagnostico-e-manejo-esc-2019`](taquicardia-supraventricular-diagnostico-e-manejo-esc-2019.md);
- pré-excitação / WPW no consultório → PS — [`pre-excitacao-wpw-no-consultorio-sinais-vermelhos-quando-ir-ao-ps`](pre-excitacao-wpw-no-consultorio-sinais-vermelhos-quando-ir-ao-ps.md);
...
- ACC/AHA/HRS 2015 (PMID 26409259): pacientes com TSV recorrente sintomática devem ser avaliados para estratégia definitiva (incluindo ablação); síncope ou intolerância hemodinâmica elevam a urgência da estratificação.
...
2. **ECG de 12 derivações em ritmo sinusal** — procurar pré-excitação oculta no histórico (delta, PR curto).
...
1. Há síncope, instabilidade, QRS largo irregular ou pré-excitação + crise? → **PS agora**.
