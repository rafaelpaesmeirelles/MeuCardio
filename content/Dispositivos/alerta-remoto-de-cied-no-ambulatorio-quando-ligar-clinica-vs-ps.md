...
kind: protocolo
theme: Dispositivos
summary: 'Pacote de consultório/telefone: diante de alerta de monitoramento remoto de marca-passo, CDI ou TRC, diferencia
  emergência, avaliação urgente por dependência/captura, choque isolado estável e alertas assintomáticos da clínica
  de dispositivos.'
tags: []
source_refs:
