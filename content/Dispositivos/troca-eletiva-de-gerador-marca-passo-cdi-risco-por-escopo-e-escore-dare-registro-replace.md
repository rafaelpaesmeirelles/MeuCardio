...
O REPLACE registry quantifica o risco da troca e da adição/upgrade, e o escore DARE quantifica o risco de morte por comorbidade do paciente — os dois lados sólidos, com número real, desta decisão. Sobre a prática de reprogramar o dispositivo para reduzir o consumo de bateria e adiar a troca, **esta sessão não localizou estudo dedicado ao cenário específico de reprogramação tardia (paciente de alto risco, dispositivo próximo do ERI/EOL)** — mas há um estudo mais antigo, de outro momento clínico (reprogramação logo após o implante, a partir do limiar de captura crônico medido em 6 meses de seguimento), que quantifica quanto a reprogramação de saída (amplitude/duração de pulso) quando os limiares permitem estende a vida do gerador: Crossley GH et al., *Reprogramming pacemakers enhances longevity and is cost-effective*, Circulation. 1996;94(9 Suppl):II245-247, PMID 8901754 — em 122 pacientes com gerador capaz de medir corrente de bateria, a longevidade estimada foi de **6,95 ± 1,59 anos** nas configurações nominais de implante contra **11,16 ± 2,71 anos** nas configurações finais ajustadas pelo médico assistente dentro de margens de segurança padrão (p < 0,001) — ou seja, a reprogramação baseada em limiar de captura estendeu a longevidade estimada em **4,25 ± 2,14 anos (64%)**, a um custo médio de US$ 110 por paciente (US$ 37 por ano de vida útil ganho). **Esse número não deve ser lido como "quanto tempo uma reprogramação conservadora ganha num paciente de alto risco com bateria já no ERI"** — é de outra população (pacientes recém-implantados, seguidos por 6 meses, com ajuste guiado por limiar de captura, não por proximidade do fim de vida) e de 1996, anterior à tecnologia de eletrodo e de gerador atual. Ele sustenta o princípio geral — reprogramar consumo de saída prolonga vida útil de bateria de forma mensurável — mas não substitui um estudo dedicado ao cenário de troca eletiva em paciente de alto risco. Onde a decisão específica exigir esse número, **VERIFICAÇÃO HUMANA NECESSÁRIA**.
...
- Crossley GH, Gayle DD, Simmons TW, Haisty WK, Bailey JR, Davis-O'Brien K, Hammon JW, Fitzgerald DM. Reprogramming pacemakers enhances longevity and is cost-effective. Circulation. 1996;94(9 Suppl):II245-247. PMID: 8901754.
