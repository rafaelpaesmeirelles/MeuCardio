...
summary: "Diante de suspeita de infecção de bolsa de CIED, a árvore separa envolvimento sistêmico/endovascular, erosão e infecção local definida — que exigem extração completa — de hematoma estéril ou inflamação incisional superficial, que não devem ser aspirados nem tratados como infecção do sistema sem critérios."
...
flowchart TD
  ...
  D1 -->|"Não, achado<br/>aparentemente limitado à bolsa"| D2{"Erosão/exposição do gerador ou<br/>eletrodo, ou deiscência que se<br/>comunica com a bolsa?"}

  D2 -->|"Sim"| C2(["Erosão equivale a infecção do<br/>sistema: extração completa do<br/>gerador e eletrodos, com<br/>antibioticoterapia"])

  D2 -->|"Não"| D3{"Drenagem purulenta, trajeto fistuloso<br/>ou eritema, calor, edema e dor que<br/>definem infecção da bolsa?<br/>(não aspirar a bolsa para diagnosticar)"}

  D3 -->|"Sim"| C3(["Infecção de bolsa definida:<br/>extração completa do sistema;<br/>reavaliar se ainda há indicação e<br/>reimplantar em sítio distante só<br/>após controle da infecção"])
  ...
  D4 -->|"Sim"| C4(["Conduta conservadora do hematoma:<br/>compressão e vigilância precoce;<br/>não aspirar nem prescrever antibiótico<br/>apenas pelo hematoma. Ajustar terapia<br/>antitrombótica só após balanço entre<br/>sangramento e tromboembolismo"])
...
**Hematoma estéril não deve ser puncionado para cultura.** A aspiração pode
inocular a bolsa e um resultado negativo não exclui biofilme. Hemoculturas
devem ser obtidas antes do antibiótico quando o paciente está estável e há
suspeita sistêmica; culturas de tecido/eletrodo são colhidas na extração.
