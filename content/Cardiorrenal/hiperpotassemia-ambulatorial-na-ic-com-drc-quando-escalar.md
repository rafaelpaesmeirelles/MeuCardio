...
kind: protocolo
fonte_producao: grok
summary: "Destino ambulatorial na hiperpotassemia da IC+DRC: K >=6,5 mmol/L confirmado é emergência mesmo sem sintomas/ECG; demais casos dependem de tendência, contexto e função renal."
review_status: revisado
review_note: "Revisão clínica final 08/09/2026. K >=6,5 mmol/L confirmado passou a indicar avaliação emergencial independentemente de sintomas ou ECG; removido link para conteúdo #829 ainda ausente; preservada mensagem de não abandonar RAASi/MRA automaticamente em hiperK não grave sem impedir ajuste quando indicado."
source_refs:
...
## Emergência
**Potássio confirmado >=6,5 mmol/L → avaliação emergencial/PS mesmo sem sintomas e mesmo com ECG normal ou indisponível.** ECG pode ser pouco sensível para a gravidade da hiperpotassemia.
...
**Não suspender silenciosamente RAASi/MRA apenas pelo primeiro K elevado**, mas também não usar essa mensagem para impedir redução/suspensão temporária quando clinicamente necessária.
...
Sem dependência de conteúdos ainda não publicados.
