---
title: "Trombose de Prótese Valvar Mecânica: Diagnóstico e Decisão entre Fibrinólise e Cirurgia"
slug: trombose-de-protese-valvar-mecanica-diagnostico-e-decisao-entre-fibrinolise-e-cirurgia
theme: "Valvopatias"
kind: protocolo
...
# Trombose de Prótese Valvar Mecânica: Diagnóstico e Decisão entre Fibrinólise e Cirurgia

## Por que este documento é diferente do já publicado sobre INR-alvo
O documento `protese-valvar-escolha-mecanica-vs-biologica-e-alvo-de-inr-esc-eacts-2025.md`, já publicado nesta pasta, cobre a **prevenção crônica** da trombose de prótese mecânica — o alvo de INR por tipo/posição de prótese, a contraindicação do DOAC. Este documento cobre o **cenário agudo**: o paciente que, apesar da anticoagulação (ou por falha dela), chega com prótese mecânica trombosada — obstrutiva ou não obstrutiva — e a decisão entre fibrinólise e cirurgia precisa ser tomada em horas.

## Quando suspeitar
Trombose valvar obstrutiva deve ser prontamente suspeitada em qualquer portador de prótese valvar que apresente **dispneia recente ou evento embólico**. Ocorre principalmente em próteses mecânicas (MHV — mechanical heart valves), embora casos de trombose de bioprótese também sejam descritos e tenham manejo próprio, diferente do descrito aqui (ver seção final).

## Confirmação diagnóstica
- **Ecocardiograma transtorácico (ETT) e transesofágico (ETE)** são a base da confirmação.
