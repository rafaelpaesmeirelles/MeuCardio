...
- 'Généreux P, Piazza N, Alu MC, et al.; VARC-3 Writing Committee. Valve Academic Research Consortium 3: Updated
  Endpoint Definitions for Aortic Valve Clinical Research. J Am Coll Cardiol. 2021;77(21):2717-2746. PMID: 33888385
  — abstract e definições estruturadas conferidos via PubMed/resumos secundários nesta sessão (06/08/2026); texto
  integral com a árvore completa de subclassificação não acessado — `VERIFICAÇÃO HUMANA NECESSÁRIA` para os critérios
  ecocardiográficos numéricos exatos de cada grau.'
...
Este tema já cobre a escolha entre prótese mecânica e biológica, e a decisão
TAVI versus SAVR na estenose aórtica nativa. Faltava o passo seguinte, cada
vez mais frequente à medida que mais bioprótese é implantada em paciente mais
jovem: **o que fazer quando a bioprótese falha** — como classificar o tipo de
...
1. **Deterioração estrutural da valva (SVD)** — alteração morfológica
   **irreversível** do folheto; degeneração/calcificação progressiva do
   folheto é o mecanismo principal, levando a estenose ou regurgitação.
...
regurgitação paravalvular (leve, leve-moderada, moderada, moderada-grave,
...
Para bioprótese aórtica cirúrgica degenerada, uma opção é implantar uma
válvula transcateter **dentro** da bioprótese já existente (valve-in-valve),
evitando reoperação. O registro internacional VIVID reuniu **459 pacientes**
(idade média 77,6 anos, 56% homens) submetidos a esse procedimento.
- **fonte**: Dvir et al., JAMA 2014;312(2):162-170

**Modo de falha da bioprótese original**: estenose em 39,4% (181), 
regurgitação em 30,3% (139), combinada (estenose + regurgitação) em 30,3%
(139) — os três modos com frequência praticamente equivalente.
- **fonte**: Dvir et al., JAMA 2014

**Desfechos em 1 mês**: mortalidade de 7,6% (35 pacientes); AVC maior em 1,7%
(8 pacientes); 92,6% em classe funcional NYHA I/II.
- **fonte**: Dvir et al., JAMA 2014

**Sobrevida em 1 ano (Kaplan-Meier)**: **83,2%** — variando por tamanho de
prótese original (≤21 mm: 74,8%; >21-<25 mm: 81,8%; ≥25 mm: 93,3%) e por modo
de falha (estenose: 76,6%; regurgitação: 91,2%; combinada: 83,9%).
- **fonte**: Dvir et al., JAMA 2014
...
- Valve-in-valve não é solução universal — em prótese original muito pequena,
  o resultado hemodinâmico final pode continuar subótimo mesmo após o
  procedimento, pela sobreposição de dois mismatches.
...
- **O registro VIVID é de 2014, população e técnica de TAVI evoluíram desde
  ...
  diferente; não tratar os números como desfecho da tecnologia atual sem
