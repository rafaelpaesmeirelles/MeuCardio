...
review_note: "Árvore construída a partir do documento já publicado e revisado nesta pasta 'insuficiencia-tricuspide-grave-triluminate-e-reparo-transcateter-borda-a-borda.md', que já traz a Recommendation Table 9 da diretriz ESC/EACTS 2025 (Classe IIa, Nível A para reparo transcateter borda a borda, com a qualificação explícita de que disfunção grave de VD, disfunção grave de VE ou hipertensão pulmonar pré-capilar tornam o tratamento clínico preferido pelo risco de futilidade) e os números do ensaio TRILUMINATE Pivotal (Sorajja P et al., N Engl J Med 2023, PMID 36876753). Nesta sessão reconferi os dois PMIDs (40878295 e 36876753) via PubMed E-utilities (esummary): título, revista e ano batem exatamente com o já citado. A árvore trata explicitamente da insuficiência tricúspide SECUNDÁRIA (a mais comum na prática, por dilatação do anel/ventrículo direito) — a árvore de decisão da regurgitação mitral já publicada nesta pasta ('fluxograma-regurgitacao-mitral-esc-eacts-2025.md') cobre mecanismo mitral, não tricúspide, então não há sobreposição de assunto."
...
flowchart TD
  ...
  D3 -->|"Não"| D4{"Alto risco cirúrgico isolado, com<br/>anatomia adequada ao reparo<br/>transcateter borda a borda, em<br/>Centro de Válvula Cardíaca<br/>experiente?"}

  D4 -->|"Sim"| C4(["Reparo transcateter borda a<br/>borda (T-TEER) para melhorar<br/>qualidade de vida e promover<br/>remodelamento de VD —<br/>Classe IIa, Nível A"])
