...
kind: fluxograma
theme: Valvopatias
summary: 'Árvore com dois eixos independentes: VAB/aortopatia (SAA vs avaliação prioritária vs vigilância) e EA
  grave assintomática (sintomas no esforço, queda pressórica isolada, FEVE e critérios de intervenção precoce).'
tags: []
source_refs:
...
Prosa VAB: [sinalizadores-ambulatoriais-de-aortopatia-em-valva-aortica-bicuspide-quando-escalar](/biblioteca/sinalizadores-ambulatoriais-de-aortopatia-em-valva-aortica-bicuspide-quando-escalar).

Prosa EA: [sinalizadores-ambulatoriais-de-estenose-aortica-assintomatica-grave-vigilancia](/biblioteca/sinalizadores-ambulatoriais-de-estenose-aortica-assintomatica-grave-vigilancia).

Fluxo formal de EA: [fluxograma-estenose-aortica-assintomatica-grave-timing-de-intervencao-esc-eacts-2025](/biblioteca/fluxograma-estenose-aortica-assintomatica-grave-timing-de-intervencao-esc-eacts-2025).

Fluxo formal de SAA: [fluxograma-sindrome-aortica-aguda-esc-2024](/biblioteca/fluxograma-sindrome-aortica-aguda-esc-2024).
...
flowchart TD
  ...
  A1 -->|"Não"| A3{"Há modificador que antecipe avaliação?<br/>diâmetro/indexação/crescimento relevantes,<br/>imagem inadequada, história familiar,<br/>coarctação, gestação ou cirurgia valvar"}
  ...
  E3 -->|"Não / não factível"| E5{"Se teste realizado: queda sustentada<br/>da PA >20 mmHg sem sintomas?"}
  E5 -->|"Sim"| E6(["Critério separado: considerar intervenção<br/>IIa/C — NÃO chamar de sintomático"])
  E5 -->|"Não / teste não realizado"| E7{"FEVE <50% sem outra causa?"}
  ...
  E9 -->|"Não"| E11{"Baixo risco procedimental e outro fator<br/>ESC/EACTS2025? FEVE <55% sem outra causa,<br/>estenose muito grave, calcificação grave<br/>com progressão rápida, ou BNP repetido<br/>>3x normal sem outra explicação"}
  E11 -->|"Sim"| E12(["Abrir fluxo formal de timing<br/>Considerar intervenção IIa/B"])
  E11 -->|"Não"| E13(["Vigilância ativa estruturada<br/>clínica/eco pelo menos a cada 6 meses<br/>educação de sintomas"])
