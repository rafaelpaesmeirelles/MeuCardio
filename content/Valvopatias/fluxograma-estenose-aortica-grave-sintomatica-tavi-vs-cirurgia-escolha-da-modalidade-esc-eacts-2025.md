...
review_note: "Produção científica assistida (Claude, 26/08/2026); pendente de revisão independente e validação médica final. Lidos na íntegra, nesta sessão, o texto das seções 8.4.1 e 8.5.1 (incluindo 8.5.1.1 a 8.5.1.3) da diretriz ESC/EACTS 2025 no European Heart Journal e as imagens da Recommendation Table 4 (modo de intervenção, com notas de rodapé d e e), da Recommendation Table 5 (SAVR concomitante a CRM ou cirurgia de aorta) e da Figure 9 (fatores que favorecem SAVR ou TAVI). Classes e níveis transcritos diretamente dessas tabelas. Derivado dos documentos já publicados nesta pasta 'estenose-aortica-grave-decisao-tavi-vs-savr-esceacts-2021.md' e 'valvopatias-atualizacao-diretriz-esceacts-2025.md'; registro PubMed 40878295 reconferido via E-utilities. Não duplica os fluxogramas de decisão de intervenção (2021) nem de timing em assintomáticos (2021 e 2025), que decidem SE e QUANDO intervir — este decide QUAL modalidade. Verificação adversarial (26/08/2026, com a Recommendation Table 4, a Recommendation Table 5 e a Figure 9 abertas em imagem e o texto das seções 8.4.1 e 8.5.1): classes, níveis, notas d e e, corte de 70 anos, 4%, 12%–17%, <60 anos para prótese mecânica, DOI e PMID conferidos. Duas correções de lógica da árvore: (1) o nó de anatomia foi desdobrado em anatomia valvar (D6) e acesso transfemoral (D6b), porque a linha de TAVI não transfemoral (IIa, B) vale só para inadequados a cirurgia E a acesso transfemoral — anatomia valvar desfavorável com paciente inoperável cai na linha geral 'SAVR ou TAVI conforme Heart Team' (I, B); (2) o nó de doença concomitante passou a pressupor risco cirúrgico aceitável e a classe I/C da conduta C2 ficou restrita a SAVR durante CRM ou cirurgia da aorta ascendente, único cenário coberto pela Recommendation Table 5."
source_refs:
...
flowchart TD
  ...
  C1(["Intervenção não recomendada —<br/>tratamento clínico, decisão compartilhada<br/>e cuidados paliativos"])
...
- A conduta para expectativa de vida inferior a 1 ano (C1) deriva do limiar positivo da seção 8.4.1; a Recommendation Table 4 de 2025 não traz uma linha explícita de "não recomendado". A diretriz de 2021 tinha uma recomendação própria para esse cenário, cuja classe não foi lida nesta sessão — VERIFICAÇÃO HUMANA NECESSÁRIA se o revisor quiser citá-la.
