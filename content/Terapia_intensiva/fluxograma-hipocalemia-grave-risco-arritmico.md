...
legacy_source: "Fluxo novo criado em 23/08/2026 como complemento do protocolo hipocalemia-grave-risco-arritmico-e-reposicao-segura. NÃO revisado clinicamente por humano; VERIFICAÇÃO HUMANA NECESSÁRIA antes de publicação."
---

# Hipocalemia grave e risco arrítmico

> **PENDENTE DE REVISÃO CLÍNICA HUMANA.** Este fluxo mantém os esquemas de reposição acelerada isolados nos ramos peri-parada/parada e não deve ser usado como prescrição automática.
...
flowchart TD
  ...
  G --> H["VERIFICAÇÃO HUMANA NECESSÁRIA:<br/>conferir Fig. 3 ERC 2025 e protocolo local<br/>antes de operacionalizar doses de parada"]
...
A Fig. 3 da ERC 2025 contém esquemas acelerados para peri-parada e parada hipocalêmica. Eles estão descritos no módulo `hipocalemia-grave-risco-arritmico-e-reposicao-segura`, mas permanecem sob **VERIFICAÇÃO HUMANA NECESSÁRIA** porque erro de contexto, concentração ou velocidade pode causar dano grave.
