...
kind: fluxograma
fonte_producao: grok
summary: 'Árvore ambulatorial: alto risco → PS/urgência; intermediário → avaliação hospitalar aguda + RMC; baixo risco → plano ambulatorial com restrição
  de exercício — alinhada à ESC 2025.'
...
Prosa: [[sinalizadores-ambulatoriais-miocardite-quando-encaminhar](/biblioteca/sinalizadores-ambulatoriais-miocardite-quando-encaminhar)](/biblioteca/sinalizadores-ambulatoriais-miocardite-quando-encaminhar). Checklist: [[miocardite-checklist-ambulatorial-de-alarme](/biblioteca/miocardite-checklist-ambulatorial-de-alarme)](/biblioteca/miocardite-checklist-ambulatorial-de-alarme). Diagnóstico/EMB: [[miocardite-diagnostico-estratificacao-de-risco-e-biopsia-endomiocardica-esc-2025](/biblioteca/miocardite-diagnostico-estratificacao-de-risco-e-biopsia-endomiocardica-esc-2025)](/biblioteca/miocardite-diagnostico-estratificacao-de-risco-e-biopsia-endomiocardica-esc-2025).
...
flowchart TD
 ...
 A -->|Não| H{"Alto risco: IC/choque, síncope/parada,<br/>TV sustentada/FV, BAV avançado,<br/>FEVE nova <40% OU LGE extenso?"}
 H -->|Sim| E
 H -->|Não| M{"Intermediário: dispneia progressiva, TVNS,<br/>troponina persistente/recidivante,<br/>FEVE 41–49% ou alteração segmentar,<br/>ou FEVE ≥50% com LGE ≥2 segmentos?"}
 ...
 B -->|Seguimento após estabilização| F["Plano formal de reavaliação até seis meses;<br/>restrição de exercício e alarmes escritos"]
```
