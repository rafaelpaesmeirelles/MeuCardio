...
kind: documento
published: true
review_note: 'Revisão individual das cifras e interpretações nas fontes primárias
  já conferidas: PARADIGM/PARADISE, EMPACT/REBOOT, FINEARTS, FLOW, DAPA-HF/CKD/DELIVER,
  SUMMIT e SURPASS. Corrigidos dose de finerenona, reavaliação precoce de possível
  lesão renal aguda, ausência de prova versus prova de ausência, cálculo de NNT e
  exceção ESC DRC 2026 iSGLT2 pós-SCA IIb C; não se afirma registro brasileiro não
  verificado.'
...
- European Society of Cardiology. New ESC Guidelines recommend all patients with heart
  disease are tested for kidney disease. Press release, 28 August 2026. STAMP on CKD;
  estimativa de cerca de 100 milhões de pessoas com DRC na Europa.
...
DRC: **anormalidades de estrutura ou função renal presentes por pelo menos 3 meses**, com implicações para a saúde. Um único valor alterado não fecha o diagnóstico. Persistência ≥3 meses documenta cronicidade; alterações inesperadas exigem reavaliação precoce para excluir lesão aguda, sem aguardar três meses para decidir sobre segurança e tratamento.
...
flowchart TD
    ...
    q3m -->|Ainda não| recheck(["Reavaliar em dias/semanas para excluir lesão aguda; documentar persistência por pelo menos 3 meses para DRC"])
