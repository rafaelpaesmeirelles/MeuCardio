...
review_note: "Nenhum PMID/DOI novo foi introduzido nesta sessão. Todas as referências reutilizadas já estavam publicadas e verificadas nesta mesma pasta em sessões anteriores deste projeto (conferência original via PubMed E-utilities, registrada nos documentos de origem): CONSENSUS PMID 2883575, PARADIGM-HF PMID 25176015, DAPA-HF PMID 31535829, EMPEROR-Reduced PMID 32865377, RALES PMID 10471456, EMPHASIS-HF PMID 21073363, STRONG-HF PMID 36356631, DIAMOND (patiromer) PMID 35900838, Atualização Focada 2023 da ESC PMID 37622666. A lógica de sequenciamento por barreira de segurança (pressão arterial, frequência cardíaca/condução, função renal/potássio) deriva diretamente do perfil de efeitos adversos de cada classe já documentado nesses mesmos ensaios nesta biblioteca — nenhum corte numérico não sustentado pelas fontes foi inventado; onde a evidência não define um algoritmo numérico validado de titulação (ex. tempo exato entre doses), o texto permanece qualitativo, no mesmo padrão já adotado em 'fluxograma-resistencia-diuretica-e-congestao-refrataria-na-ic-aguda.md' desta pasta."
...
inibidor de SGLT2) — o STRONG-HF e a atualização focada 2023 da ESC reforçam
que **iniciar as quatro classes cedo, em dose baixa, e titular rapidamente**
reduz reinternação e morte em relação à titulação lenta tradicional. Mas
...
flowchart TD
  ...
  P1["Iniciar as quatro classes<br/>simultaneamente em dose baixa —<br/>iSGLT2 não exige titulação; IECA/ARNI,<br/>betabloqueador e antagonista<br/>mineralocorticoide em dose inicial<br/>mínima (STRONG-HF / ESC 2023)"]
  ...
  D3{"Na reavaliação (1 a 2 semanas): PA,<br/>FC, potássio e TFGe toleraram a dose<br/>atual?"}
  C5(["Dobrar a dose de uma classe por vez<br/>até a meta ou a dose máxima tolerada,<br/>reavaliando clínica e<br/>laboratorialmente a cada 2 semanas, até<br/>as quatro classes em dose-alvo"])
