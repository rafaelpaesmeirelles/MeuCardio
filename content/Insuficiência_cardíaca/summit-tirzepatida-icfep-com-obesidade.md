...
- **731 pacientes** com insuficiência cardíaca, **fração de ejeção de pelo menos 50%** e **IMC de pelo menos 30 kg/m²**
- Randomização **1:1** — **364** para tirzepatida (até **15 mg subcutânea uma vez por semana**) e **367** para placebo, por **pelo menos 52 semanas**
- Seguimento mediano de **104 semanas**
- **Dois desfechos primários**:
...
| Desfecho | Tirzepatida (n=364) | Placebo (n=367) | Efeito |
|---|---|---|---|
| **Composto primário** (morte CV adjudicada ou piora da IC) | **36 (9,9%)** | **56 (15,3%)** | **HR 0,62** (IC95% 0,41 a 0,95); **p = 0,026** |
| **Evento de piora da IC** | **29 (8,0%)** | **52 (14,2%)** | **HR 0,54** (IC95% 0,34 a 0,85) |
| **Morte CV adjudicada** | **8 (2,2%)** | **5 (1,4%)** | **HR 1,58** (IC95% 0,52 a 4,83) |
...
1. A recomendação IIa B1 é para **peso, capacidade de exercício e qualidade de vida** — não para reduzir morte ou hospitalização como Classe I.
...
- **Tratar tirzepatida como semaglutida** — agonismo duplo GIP/GLP-1, ensaio distinto, desfechos primários distintos; não há comparação direta randomizada entre as duas nesta população
- **Extrapolar para ICFEp sem obesidade** — IMC ≥ 30 kg/m² era critério de entrada
