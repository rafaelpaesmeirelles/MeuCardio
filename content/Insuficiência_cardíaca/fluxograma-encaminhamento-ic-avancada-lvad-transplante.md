...
Universal de IC (2026) e do teste cardiopulmonar de exercício, que é o exame
que mais frequentemente decide o momento.

## Árvore de decisão

```mermaid
flowchart TD
  R0["ICFEr em terapia quádrupla otimizada<br/>(doses-alvo ou máximas toleradas) por<br/>tempo adequado, com sintomas<br/>persistentes"]
  ...
  C1(["Manter a otimização ambulatorial da<br/>terapia quádrupla e a reavaliação<br/>periódica — sem critério de<br/>encaminhamento a IC avançada neste<br/>momento"])
  ...
  C3(["Encaminhar a centro de IC avançada<br/>para avaliação formal de transplante<br/>cardíaco e/ou LVAD — o TCPE atingiu o<br/>corte que sustenta a indicação (Mancini<br/>1991, Peterson 2003, ISHLT 2024)"])
  D4{"Contraindicação já conhecida a<br/>transplante (neoplasia ativa, disfunção<br/>grave irreversível de outro órgão,<br/>doença psiquiátrica não controlada que<br/>impeça adesão, ausência de suporte<br/>social) presente?"}
  C4(["Priorizar avaliação de LVAD como<br/>terapia de destino, se elegível, em vez<br/>da via de transplante — decisão do<br/>centro especializado de IC avançada,<br/>não deste fluxograma (MOMENTUM 3)"])
  ...
  D4 -->|"Sim — contraindicação conhecida a<br/>transplante"| C4
  D4 -->|"Não"| C5
