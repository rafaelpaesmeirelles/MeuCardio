...
published: false
review_note: "Revisão clínica individual concluída em 08/09/2026: estudos unicêntricos conferidos; dP/dt e RVAD precoce mantidos como adjuntos, sem regra automática."
...
O LVAD descarrega o ventrículo esquerdo, reduz pressões de enchimento esquerdas e aumenta o retorno venoso que o VD precisa ejetar. A resistência vascular pulmonar pode persistir; sucção excessiva e desvio do septo para a esquerda também podem piorar geometria/contratilidade do VD e regurgitação tricúspide. A combinação de maior pré-carga, reserva contrátil limitada e pós-carga residual é o pano de fundo da falência de VD pós-implante. Não há modelo preditivo único amplamente validado, e as definições variam entre coortes.
...
- **RV dP/dt ≥300 mmHg/s, medido fora de suporte inotrópico**, identificou um subgrupo de menor risco, com **sensibilidade de 89% e valor preditivo negativo de 91%**. É resultado de coorte pequena (65 pacientes), útil como complemento, não como teste isolado para excluir falência grave.
...
Um estudo publicado em *ESC Heart Failure* (2025) comparou desfechos entre receptores de HeartMate 3 que precisaram e que não precisaram de RVAD temporário (tRVAD). Em uma coorte selecionada de centro com 192 pacientes, **51 (26%) precisaram de tRVAD**; essa incidência não deve ser generalizada a todos os programas.
...
1. **A falência de VD pós-LVAD é grave**; em uma coorte selecionada, 26% precisaram de suporte temporário, mas essa frequência depende da população e do protocolo do centro.
...
3. **Discutir suporte precoce em pacientes selecionados**: uma coorte retrospectiva unicêntrica de 64 casos associou RVAD temporário *upfront* a menor mortalidade que resgate tardio (33% vs. 68% em 90 dias). O achado não estabelece regra universal de implante nem substitui avaliação pelo *heart team*.
