...
summary: 'Árvore de consultório: urgência primeiro; deficiência de ferro + IC sintomática com fenótipo elegível
  → ferro EV; pós-alta AFFIRM-AHF restrito a FEVE<50%; ICFEp não é extrapolada.'
tags: []
source_refs:
...
```mermaid
flowchart TD
  R0["Consulta de IC + suspeita/deficiência de ferro"] --> D1{"Instabilidade, sangramento ativo relevante<br/>ou reação de hipersensibilidade aguda?"}
  ...
  D3 -->|"Sim"| D4{"Hipersensibilidade grave prévia<br/>a qualquer produto de ferro EV?"}
