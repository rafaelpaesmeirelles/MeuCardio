...
- **`evidencias/` cresceu em volume, não em amplitude.** Passou de 32 para 104 itens
  ...
  AAA, ESC 2024); Saúde mental ganhou uma segunda (ISRS na depressão em DAC,
  ESC 2021). Arritmias, Dispositivos, Farmacologia, Hipertensão e Tromboembolismo
  seguem com uma só.
- **`estudos/` zerou Cardiopatias congênitas e Febre reumática** (BREATHE-5 e o
  ...
  aprofundou Hipertensão pulmonar (AMBITION), Tromboembolismo (EINSTEIN-PE) e
  Terapia intensiva (TTM2), que tinham só 1 item. Resta só Comunicação clínica,
  Geral e Farmacologia sem nenhum estudo — os
