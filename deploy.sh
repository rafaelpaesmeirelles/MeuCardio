...
# que um AI_PROVIDER legado do .env governe a indexação do deploy.
...
# configuração são certificados abaixo; qualidade do provedor tem validação
# própria, com reserva institucional, fora da indisponibilidade do deploy.
validar_checkout_imutavel
...
# `reconcile_content` acima só mexe em Postgres
