...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("conselho_check_status", sa.String(30), nullable=False, server_default="nao_verificado"),
        sa.Column("conselho_check_detalhe", sa.String(500), nullable=True),
        sa.Column("conselho_check_em", sa.DateTime(timezone=True), nullable=True),
