"""Arquivos originais vinculados a resultados de exames do prontuário.
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["exam_result_id"], ["patient_exam_results.id"], ondelete="RESTRICT"),
    ...
    op.create_index("ix_patient_exam_attachments_exam_result_id", _TABLE, ["exam_result_id"], unique=False)
