"""Contrato do aprofundamento Tudo com Tudo do plano de parto na cardiopatia materna — 28/08/2026."""
...
def test_patient_material_slug_resolve():
 i=_load_doencas()[SLUG]; m=i.get("patient_material_slug"); assert m=="plano-parto-cardiopatia-materna"; assert m in {x["slug"] for x in json.loads((REPOSITORY_ROOT/"material-paciente/metadados.json").read_text(encoding="utf-8"))}