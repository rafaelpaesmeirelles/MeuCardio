...
PENDENTES_LOTES_TUDO_COM_TUDO: dict[str, set[str]] = {
    "doencas/metadados.json": {
        ...
        # amiloidose-cardiaca-cadeia-leve.json — ver review_note do próprio
        ...
        # continua falhando para "amiloidose-cardiaca-cadeia-leve", como
        # esperado e documentado.
        "amiloidose-cardiaca-cadeia-leve",
    },
}
