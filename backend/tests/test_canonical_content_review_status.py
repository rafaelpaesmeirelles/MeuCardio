...
PENDENTES_LOTES_TUDO_COM_TUDO: dict[str, set[str]] = {
    "doencas/metadados.json": {
        ...
        # emergencia-hipertensiva.json — ver review_note do próprio
        ...
        # continua falhando para "emergencia-hipertensiva", como esperado e
        # documentado (mesmo padrão do PR #698, cardiomiopatia-de-takotsubo).
