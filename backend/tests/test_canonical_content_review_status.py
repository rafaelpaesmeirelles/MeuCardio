...
PENDENTES_LOTES_TUDO_COM_TUDO: dict[str, set[str]] = {
    "doencas/metadados.json": {
        # Verbete-hub Tudo com Tudo de Canalopatias cardíacas hereditárias
        # (geral), criado em 27/08/2026: slug novo, sem sobreposição com
        # canalopatias-pediatricas nem com qt-longo-terapia-oncologica —
        # ver review_note.
