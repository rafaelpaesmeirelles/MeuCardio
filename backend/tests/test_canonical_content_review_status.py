...
PENDENTES_LOTES_TUDO_COM_TUDO: dict[str, set[str]] = {
    "doencas/metadados.json": {
        ...
        # plano-parto-cardiopatia-materna passou de completeness=basico
        # (só catalogação, zero related_document_slugs) para completo,
        # com conteúdo clínico integral e 6 related_document_slugs — ver
        # review_note.
        "plano-parto-cardiopatia-materna",
    },
}
