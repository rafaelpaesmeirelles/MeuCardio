...
PENDENTES_LOTES_TUDO_COM_TUDO: dict[str, set[str]] = {
    "doencas/metadados.json": {
        ...
        # avaliacao-multidimensional-cardiogeriatrica passou de
        # completeness=basico (só catalogação + 3 related_document_slugs)
        # para completo, com conteúdo clínico integral e 5
        # related_document_slugs — ver review_note.
        "avaliacao-multidimensional-cardiogeriatrica",
    },
}
