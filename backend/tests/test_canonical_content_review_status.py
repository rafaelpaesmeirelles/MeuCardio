...
PENDENTES_LOTES_TUDO_COM_TUDO: dict[str, set[str]] = {
    "doencas/metadados.json": {
        ...
        # plano-alta-cardiogeriatria passou de completeness=basico (só
        # catalogação, 1 source_ref) para completo, com conteúdo clínico
        # integral; os 3 related_document_slugs pré-existentes foram
        # reconfirmados por leitura direta — ver review_note.
        "plano-alta-cardiogeriatria",
    },
}
