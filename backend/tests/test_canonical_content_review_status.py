...
PENDENTES_LOTES_TUDO_COM_TUDO: dict[str, set[str]] = {
    "doencas/metadados.json": {
        ...
        # indicacoes-ecocardiograma-fetal passou de completeness=basico
        # (só catalogação, 1 related_document_slug) para completo, com
        # conteúdo clínico integral e 3 related_document_slugs — ver
        # review_note.
        "indicacoes-ecocardiograma-fetal",
    },
}
