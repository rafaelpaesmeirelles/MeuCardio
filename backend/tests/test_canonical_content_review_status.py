...
PENDENTES_LOTES_TUDO_COM_TUDO: dict[str, set[str]] = {
    "doencas/metadados.json": {
        # Verbete novo criado em 29/08/2026 via doencas/fragmentos/cteph.json —
        # ver review_note do próprio registro. Esta entrada é usada por
        ...
        # continua falhando para "cteph", como esperado e documentado. Segue
        # o mesmo padrão já usado pela PR #698 (cardiomiopatia-de-takotsubo).
        "cteph",
    },
}
