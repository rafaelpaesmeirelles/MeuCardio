...
PENDENTES_LOTES_TUDO_COM_TUDO: dict[str, set[str]] = {
    "doencas/metadados.json": {
        ...
        # torsades-de-pointes-qt-longo-adquirido.json — ver review_note do
        # próprio registro. Esta entrada é usada por
        ...
        # continua falhando para "torsades-de-pointes-qt-longo-adquirido",
        # como esperado e documentado (mesmo padrão da PR #698,
        # "cardiomiopatia-de-takotsubo").
        "torsades-de-pointes-qt-longo-adquirido",
    },
}
