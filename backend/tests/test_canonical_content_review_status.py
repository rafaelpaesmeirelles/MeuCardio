...
PENDENTES_LOTES_TUDO_COM_TUDO: dict[str, set[str]] = {
    "doencas/metadados.json": {
        ...
        # sarcoidose-cardiaca.json — ver review_note do próprio registro.
        # Esta entrada é usada por test_disease_fragments_canonical.py
        # (onde a checagem funciona corretamente contra status pendente).
        # Ela NÃO isenta este slug do teste principal abaixo, cuja lógica
        # só consulta esta allowlist para registros já com
        # status="revisado" — por isso
        # test_manifestos_canonicos_so_tem_pendencias_explicitamente_aprovadas_para_rc
        # continua falhando para "sarcoidose-cardiaca", como esperado e
        # documentado (mesmo padrão da PR #698, cardiomiopatia-de-takotsubo).
        "sarcoidose-cardiaca",
    },
}
