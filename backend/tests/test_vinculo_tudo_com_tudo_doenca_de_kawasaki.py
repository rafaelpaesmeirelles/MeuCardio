"""Contrato do fechamento de lacuna Tudo com Tudo da doença de Kawasaki — 28/08/2026."""
...
def test_patient_material_slug_resolve():
 i=_load_doencas()[SLUG]; m=i.get("patient_material_slug"); assert m=="doenca-de-kawasaki-o-que-os-pais-precisam-saber"; assert m in {x["slug"] for x in json.loads((REPOSITORY_ROOT/"material-paciente/metadados.json").read_text(encoding="utf-8"))}