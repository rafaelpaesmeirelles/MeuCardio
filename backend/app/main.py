...
from app.api import (
    account_access_admin, account_sync, admin, admin_user_delete, admin_user_management, ai, appointments, assinatura, auth, avaliacao_preoperatoria, browser_session,
...
ROUTERS_LIVRES = (
    ...
    # admin_user_delete precede o handler legado apenas para DELETE /user-management/{id}.
    account_access_admin.router, admin.router, admin_user_delete.router, admin_user_management.router,
